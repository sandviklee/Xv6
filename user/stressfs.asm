...
printint(int fd, int xx, int base, int sgn)
{
 ...
 49a:	4ca50513          	addi	a0,a0,1226 # 960 <digits>
 49e:	883a                	mv	a6,a4
...
void vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 59e:	36e70713          	addi	a4,a4,878 # 908 <malloc+0x136>
 ...
 628:	33cb8b93          	addi	s7,s7,828 # 960 <digits>
 ...
 67c:	28890913          	addi	s2,s2,648 # 900 <malloc+0x12e>
        while (*s != 0)
...
malloc(uint nbytes)
{
 ...
 8ac:	b72080e7          	jalr	-1166(ra) # 41a <sbrk>
  if(p == (char*)-1)
