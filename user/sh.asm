...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	30e58593          	addi	a1,a1,782 # 1320 <malloc+0xea>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	2c858593          	addi	a1,a1,712 # 1328 <malloc+0xf2>
      68:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	29650513          	addi	a0,a0,662 # 1330 <malloc+0xfa>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	36a70713          	addi	a4,a4,874 # 1430 <malloc+0x1fa>
    ...
    panic("runcmd");
      ...
      e4:	25850513          	addi	a0,a0,600 # 1338 <malloc+0x102>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	23e58593          	addi	a1,a1,574 # 1340 <malloc+0x10a>
     10a:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     152:	20258593          	addi	a1,a1,514 # 1350 <malloc+0x11a>
     156:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     1e8:	17c50513          	addi	a0,a0,380 # 1360 <malloc+0x12a>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5ba:	dd2b8b93          	addi	s7,s7,-558 # 1388 <malloc+0x152>
  ...
  while(peek(ps, es, "<>")){
     ...
     5cc:	da050513          	addi	a0,a0,-608 # 1368 <malloc+0x132>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6b4:	ce060613          	addi	a2,a2,-800 # 1390 <malloc+0x15a>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6e4:	cd0b0b13          	addi	s6,s6,-816 # 13b0 <malloc+0x17a>
  ...
  return ret;
     ...
     71e:	c7e50513          	addi	a0,a0,-898 # 1398 <malloc+0x162>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     780:	c2450513          	addi	a0,a0,-988 # 13a0 <malloc+0x16a>
...
000000000000079a <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7ba:	c0260613          	addi	a2,a2,-1022 # 13b8 <malloc+0x182>
     7be:	85ce                	mv	a1,s3
     7c0:	854a                	mv	a0,s2
...
0000000000000808 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     82a:	b9aa0a13          	addi	s4,s4,-1126 # 13c0 <malloc+0x18a>
  ...
  if(peek(ps, es, ";")){
     ...
     860:	b6c60613          	addi	a2,a2,-1172 # 13c8 <malloc+0x192>
     864:	85ce                	mv	a1,s3
     866:	854a                	mv	a0,s2
...
00000000000008b0 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8c6:	ace60613          	addi	a2,a2,-1330 # 1390 <malloc+0x15a>
  ...
  if(!peek(ps, es, ")"))
     ...
     8f6:	aee60613          	addi	a2,a2,-1298 # 13e0 <malloc+0x1aa>
     8fa:	85ca                	mv	a1,s2
     8fc:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     938:	a9c50513          	addi	a0,a0,-1380 # 13d0 <malloc+0x19a>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     974:	ad870713          	addi	a4,a4,-1320 # 1448 <malloc+0x212>
...
00000000000009ec <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a20:	9e460613          	addi	a2,a2,-1564 # 1400 <malloc+0x1ca>
     a24:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a56:	9b658593          	addi	a1,a1,-1610 # 1408 <malloc+0x1d2>
     a5a:	4509                	li	a0,2
     a5c:	00000097          	auipc	ra,0x0
     a60:	6f4080e7          	jalr	1780(ra) # 1150 <fprintf>
    panic("syntax");
     a64:	00001517          	auipc	a0,0x1
     a68:	93450513          	addi	a0,a0,-1740 # 1398 <malloc+0x162>
...
0000000000000a74 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a88:	99448493          	addi	s1,s1,-1644 # 1418 <malloc+0x1e2>
     a8c:	4589                	li	a1,2
     a8e:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b3e:	8e658593          	addi	a1,a1,-1818 # 1420 <malloc+0x1ea>
     b42:	4509                	li	a0,2
     b44:	00000097          	auipc	ra,0x0
     b48:	60c080e7          	jalr	1548(ra) # 1150 <fprintf>
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     ecc:	f4e080e7          	jalr	-178(ra) # e16 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
  if (sgn && xx < 0)
     ee8:	c299                	beqz	a3,eee <printint+0x16>
     eea:	0805c963          	bltz	a1,f7c <printint+0xa4>
    neg = 1;
    x = -xx;
  }
  else
  ...
  do
  {
    buf[i++] = digits[x % base];
     ...
     efe:	5c650513          	addi	a0,a0,1478 # 14c0 <digits>
     f02:	883a                	mv	a6,a4
     ...
     f22:	fec7f0e3          	bgeu	a5,a2,f02 <printint+0x2a>
  if (neg)
     f26:	00088c63          	beqz	a7,f3e <printint+0x66>
    buf[i++] = '-';
  ...
  while (--i >= 0)
     f3e:	02e05863          	blez	a4,f6e <printint+0x96>
  ...
  while (--i >= 0)
     ...
     f74:	7902                	ld	s2,32(sp)
     f76:	69e2                	ld	s3,24(sp)
...
void vprintf(int fd, const char *fmt, va_list ap)
{
     ...
     f8e:	f44e                	sd	s3,40(sp)
     f90:	f052                	sd	s4,32(sp)
     f92:	ec56                	sd	s5,24(sp)
     f94:	e85a                	sd	s6,16(sp)
     f96:	e45e                	sd	s7,8(sp)
     f98:	e062                	sd	s8,0(sp)
  ...
  for (i = 0; fmt[i]; i++)
     ...
     fa0:	18090c63          	beqz	s2,1138 <vprintf+0x1b4>
     fa4:	8aaa                	mv	s5,a0
     fa6:	8bb2                	mv	s7,a2
  ...
  state = 0;
     ...
     fb2:	4b55                	li	s6,21
     fb4:	a839                	j	fd2 <vprintf+0x4e>
        putc(fd, c);
     fb6:	85ca                	mv	a1,s2
     fb8:	8556                	mv	a0,s5
     fba:	00000097          	auipc	ra,0x0
     fbe:	efc080e7          	jalr	-260(ra) # eb6 <putc>
     fc2:	a019                	j	fc8 <vprintf+0x44>
    else if (state == '%')
     fc4:	01498d63          	beq	s3,s4,fde <vprintf+0x5a>
  for (i = 0; fmt[i]; i++)
     fc8:	0485                	addi	s1,s1,1
     fca:	fff4c903          	lbu	s2,-1(s1)
     fce:	16090563          	beqz	s2,1138 <vprintf+0x1b4>
    if (state == 0)
     fd2:	fe0999e3          	bnez	s3,fc4 <vprintf+0x40>
      if (c == '%')
     fd6:	ff4910e3          	bne	s2,s4,fb6 <vprintf+0x32>
        state = '%';
     fda:	89d2                	mv	s3,s4
     fdc:	b7f5                	j	fc8 <vprintf+0x44>
    {
      if (c == 'd')
     fde:	13490263          	beq	s2,s4,1102 <vprintf+0x17e>
     fe2:	f9d9079b          	addiw	a5,s2,-99
     fe6:	0ff7f793          	zext.b	a5,a5
     fea:	12fb6563          	bltu	s6,a5,1114 <vprintf+0x190>
     fee:	f9d9079b          	addiw	a5,s2,-99
     ff2:	0ff7f713          	zext.b	a4,a5
     ff6:	10eb6f63          	bltu	s6,a4,1114 <vprintf+0x190>
     ffa:	00271793          	slli	a5,a4,0x2
     ffe:	00000717          	auipc	a4,0x0
    1002:	46a70713          	addi	a4,a4,1130 # 1468 <malloc+0x232>
    ...
    1020:	ebc080e7          	jalr	-324(ra) # ed8 <printint>
    1024:	8bca                	mv	s7,s2
      {
    ...
    103c:	ea0080e7          	jalr	-352(ra) # ed8 <printint>
    1040:	8bca                	mv	s7,s2
      state = 0;
    1042:	4981                	li	s3,0
    1044:	b751                	j	fc8 <vprintf+0x44>
    ...
    1058:	e84080e7          	jalr	-380(ra) # ed8 <printint>
    105c:	8bca                	mv	s7,s2
      state = 0;
    105e:	4981                	li	s3,0
    1060:	b7a5                	j	fc8 <vprintf+0x44>
  ...
  putc(fd, 'x');
    ...
    108c:	438b8b93          	addi	s7,s7,1080 # 14c0 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10ac:	8be2                	mv	s7,s8
      state = 0;
    10ae:	4981                	li	s3,0
    10b0:	bf21                	j	fc8 <vprintf+0x44>
        s = va_arg(ap, char *);
    10b2:	008b8993          	addi	s3,s7,8
    10b6:	000bb903          	ld	s2,0(s7)
        if (s == 0)
    10ba:	02090163          	beqz	s2,10dc <vprintf+0x158>
        while (*s != 0)
    10be:	00094583          	lbu	a1,0(s2)
    10c2:	c9a5                	beqz	a1,1132 <vprintf+0x1ae>
          putc(fd, *s);
    10c4:	8556                	mv	a0,s5
    10c6:	00000097          	auipc	ra,0x0
    10ca:	df0080e7          	jalr	-528(ra) # eb6 <putc>
          s++;
    10ce:	0905                	addi	s2,s2,1
        while (*s != 0)
    10d0:	00094583          	lbu	a1,0(s2)
    10d4:	f9e5                	bnez	a1,10c4 <vprintf+0x140>
        s = va_arg(ap, char *);
    10d6:	8bce                	mv	s7,s3
      state = 0;
    10d8:	4981                	li	s3,0
    10da:	b5fd                	j	fc8 <vprintf+0x44>
          s = "(null)";
    10dc:	00000917          	auipc	s2,0x0
    10e0:	38490913          	addi	s2,s2,900 # 1460 <malloc+0x22a>
        while (*s != 0)
    10e4:	02800593          	li	a1,40
    10e8:	bff1                	j	10c4 <vprintf+0x140>
        putc(fd, va_arg(ap, uint));
    10ea:	008b8913          	addi	s2,s7,8
    10ee:	000bc583          	lbu	a1,0(s7)
    10f2:	8556                	mv	a0,s5
    10f4:	00000097          	auipc	ra,0x0
    10f8:	dc2080e7          	jalr	-574(ra) # eb6 <putc>
    10fc:	8bca                	mv	s7,s2
      state = 0;
    10fe:	4981                	li	s3,0
    1100:	b5e1                	j	fc8 <vprintf+0x44>
        putc(fd, c);
    1102:	02500593          	li	a1,37
    1106:	8556                	mv	a0,s5
    1108:	00000097          	auipc	ra,0x0
    110c:	dae080e7          	jalr	-594(ra) # eb6 <putc>
      state = 0;
    1110:	4981                	li	s3,0
    1112:	bd5d                	j	fc8 <vprintf+0x44>
        putc(fd, '%');
    1114:	02500593          	li	a1,37
    1118:	8556                	mv	a0,s5
    111a:	00000097          	auipc	ra,0x0
    111e:	d9c080e7          	jalr	-612(ra) # eb6 <putc>
        putc(fd, c);
    1122:	85ca                	mv	a1,s2
    1124:	8556                	mv	a0,s5
    1126:	00000097          	auipc	ra,0x0
    112a:	d90080e7          	jalr	-624(ra) # eb6 <putc>
      state = 0;
    112e:	4981                	li	s3,0
    1130:	bd61                	j	fc8 <vprintf+0x44>
        s = va_arg(ap, char *);
    1132:	8bce                	mv	s7,s3
      state = 0;
    1134:	4981                	li	s3,0
    1136:	bd49                	j	fc8 <vprintf+0x44>
    }
  }
}
    ...
    11ea:	00e6ea63          	bltu	a3,a4,11fe <free+0x4a>
{
  ...
  freep = p;
    ...
    122c:	def73423          	sd	a5,-536(a4) # 2010 <freep>
}
...
malloc(uint nbytes)
{
    ...
    1242:	e852                	sd	s4,16(sp)
    1244:	e456                	sd	s5,8(sp)
    1246:	e05a                	sd	s6,0(sp)
    1248:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    124a:	02051493          	slli	s1,a0,0x20
    124e:	9081                	srli	s1,s1,0x20
    1250:	04bd                	addi	s1,s1,15
    1252:	8091                	srli	s1,s1,0x4
    1254:	0014899b          	addiw	s3,s1,1
    1258:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    125a:	00001517          	auipc	a0,0x1
    125e:	db653503          	ld	a0,-586(a0) # 2010 <freep>
    1262:	c515                	beqz	a0,128e <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1268:	02977f63          	bgeu	a4,s1,12a6 <malloc+0x70>
  if(nu < 4096)
    126c:	8a4e                	mv	s4,s3
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1286:	d8e90913          	addi	s2,s2,-626 # 2010 <freep>
  if(p == (char*)-1)
    128a:	5afd                	li	s5,-1
    128c:	a895                	j	1300 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    128e:	00001797          	auipc	a5,0x1
    1292:	dfa78793          	addi	a5,a5,-518 # 2088 <base>
    1296:	00001717          	auipc	a4,0x1
    129a:	d6f73d23          	sd	a5,-646(a4) # 2010 <freep>
    129e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    12a0:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    12a4:	b7e1                	j	126c <malloc+0x36>
      if(p->s.size == nunits)
    12a6:	02e48c63          	beq	s1,a4,12de <malloc+0xa8>
        p->s.size -= nunits;
    ...
    12e2:	bff1                	j	12be <malloc+0x88>
  hp->s.size = nu;
    12e4:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    12e8:	0541                	addi	a0,a0,16
    12ea:	00000097          	auipc	ra,0x0
    12ee:	eca080e7          	jalr	-310(ra) # 11b4 <free>
  return freep;
    12f2:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    12f6:	d971                	beqz	a0,12ca <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    12f8:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    12fa:	4798                	lw	a4,8(a5)
    12fc:	fa9775e3          	bgeu	a4,s1,12a6 <malloc+0x70>
    if(p == freep)
    1300:	00093703          	ld	a4,0(s2)
    1304:	853e                	mv	a0,a5
    1306:	fef719e3          	bne	a4,a5,12f8 <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
    130a:	8552                	mv	a0,s4
    130c:	00000097          	auipc	ra,0x0
    1310:	b72080e7          	jalr	-1166(ra) # e7e <sbrk>
  if(p == (char*)-1)
    1314:	fd5518e3          	bne	a0,s5,12e4 <malloc+0xae>
        return 0;
    1318:	4501                	li	a0,0
    131a:	bf45                	j	12ca <malloc+0x94>
