...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	08250513          	addi	a0,a0,130 # 60c0 <malloc+0xf2>
      46:	00006097          	auipc	ra,0x6
      4a:	ed0080e7          	jalr	-304(ra) # 5f16 <printf>
      exit(1);
      4e:	4505                	li	a0,1
      ...
      74:	8082                	ret
{
      ...
      84:	06050513          	addi	a0,a0,96 # 60e0 <malloc+0x112>
      88:	00006097          	auipc	ra,0x6
      8c:	e8e080e7          	jalr	-370(ra) # 5f16 <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	05050513          	addi	a0,a0,80 # 60f8 <malloc+0x12a>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	05250513          	addi	a0,a0,82 # 6118 <malloc+0x14a>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	01a50513          	addi	a0,a0,26 # 6100 <malloc+0x132>
      ee:	00006097          	auipc	ra,0x6
      f2:	e28080e7          	jalr	-472(ra) # 5f16 <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	02650513          	addi	a0,a0,38 # 6128 <malloc+0x15a>
     10a:	00006097          	auipc	ra,0x6
     10e:	e0c080e7          	jalr	-500(ra) # 5f16 <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	02450513          	addi	a0,a0,36 # 6150 <malloc+0x182>
     134:	00006097          	auipc	ra,0x6
     138:	aaa080e7          	jalr	-1366(ra) # 5bde <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	01050513          	addi	a0,a0,16 # 6150 <malloc+0x182>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	00c58593          	addi	a1,a1,12 # 6160 <malloc+0x192>
     15c:	00006097          	auipc	ra,0x6
     160:	a52080e7          	jalr	-1454(ra) # 5bae <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	fe850513          	addi	a0,a0,-24 # 6150 <malloc+0x182>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	fec58593          	addi	a1,a1,-20 # 6168 <malloc+0x19a>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	fbc50513          	addi	a0,a0,-68 # 6150 <malloc+0x182>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	fa650513          	addi	a0,a0,-90 # 6170 <malloc+0x1a2>
     1d2:	00006097          	auipc	ra,0x6
     1d6:	d44080e7          	jalr	-700(ra) # 5f16 <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	f1c50513          	addi	a0,a0,-228 # 6198 <malloc+0x1ca>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	f08a8a93          	addi	s5,s5,-248 # 6198 <malloc+0x1ca>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	e9650513          	addi	a0,a0,-362 # 61a8 <malloc+0x1da>
     31a:	00006097          	auipc	ra,0x6
     31e:	bfc080e7          	jalr	-1028(ra) # 5f16 <printf>
      exit(1);
     322:	4505                	li	a0,1
     ...
     338:	e9450513          	addi	a0,a0,-364 # 61c8 <malloc+0x1fa>
     33c:	00006097          	auipc	ra,0x6
     340:	bda080e7          	jalr	-1062(ra) # 5f16 <printf>
        exit(1);
     344:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     362:	e8250513          	addi	a0,a0,-382 # 61e0 <malloc+0x212>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     376:	e6e98993          	addi	s3,s3,-402 # 61e0 <malloc+0x212>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c2:	e2250513          	addi	a0,a0,-478 # 61e0 <malloc+0x212>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3da:	d9258593          	addi	a1,a1,-622 # 6168 <malloc+0x19a>
    ...
    printf("write failed\n");
     ...
     3f0:	e1450513          	addi	a0,a0,-492 # 6200 <malloc+0x232>
     3f4:	00006097          	auipc	ra,0x6
     3f8:	b22080e7          	jalr	-1246(ra) # 5f16 <printf>
    exit(1);
     3fc:	4505                	li	a0,1
     ...
     40a:	de250513          	addi	a0,a0,-542 # 61e8 <malloc+0x21a>
     40e:	00006097          	auipc	ra,0x6
     412:	b08080e7          	jalr	-1272(ra) # 5f16 <printf>
      exit(1);
     416:	4505                	li	a0,1
    ...
    printf("open junk failed\n");
     ...
     424:	dc850513          	addi	a0,a0,-568 # 61e8 <malloc+0x21a>
     428:	00006097          	auipc	ra,0x6
     42c:	aee080e7          	jalr	-1298(ra) # 5f16 <printf>
    exit(1);
     430:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     448:	d9c50513          	addi	a0,a0,-612 # 61e0 <malloc+0x212>
...
000000000000052e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     554:	cc0a0a13          	addi	s4,s4,-832 # 6210 <malloc+0x242>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     600:	c1c50513          	addi	a0,a0,-996 # 6218 <malloc+0x24a>
     604:	00006097          	auipc	ra,0x6
     608:	912080e7          	jalr	-1774(ra) # 5f16 <printf>
      exit(1);
     60c:	4505                	li	a0,1
     ...
     61e:	c1650513          	addi	a0,a0,-1002 # 6230 <malloc+0x262>
     622:	00006097          	auipc	ra,0x6
     626:	8f4080e7          	jalr	-1804(ra) # 5f16 <printf>
      exit(1);
     62a:	4505                	li	a0,1
     ...
     63c:	c2850513          	addi	a0,a0,-984 # 6260 <malloc+0x292>
     640:	00006097          	auipc	ra,0x6
     644:	8d6080e7          	jalr	-1834(ra) # 5f16 <printf>
      exit(1);
     648:	4505                	li	a0,1
     ...
     656:	c3e50513          	addi	a0,a0,-962 # 6290 <malloc+0x2c2>
     65a:	00006097          	auipc	ra,0x6
     65e:	8bc080e7          	jalr	-1860(ra) # 5f16 <printf>
      exit(1);
     662:	4505                	li	a0,1
     ...
     674:	c3050513          	addi	a0,a0,-976 # 62a0 <malloc+0x2d2>
     678:	00006097          	auipc	ra,0x6
     67c:	89e080e7          	jalr	-1890(ra) # 5f16 <printf>
      exit(1);
     680:	4505                	li	a0,1
...
000000000000068a <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b2:	c22a0a13          	addi	s4,s4,-990 # 62d0 <malloc+0x302>
    n = write(fds[1], "x", 1);
     6b6:	00006a97          	auipc	s5,0x6
     6ba:	ab2a8a93          	addi	s5,s5,-1358 # 6168 <malloc+0x19a>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     760:	b7c50513          	addi	a0,a0,-1156 # 62d8 <malloc+0x30a>
     764:	00005097          	auipc	ra,0x5
     768:	7b2080e7          	jalr	1970(ra) # 5f16 <printf>
      exit(1);
     76c:	4505                	li	a0,1
     ...
     77e:	b7650513          	addi	a0,a0,-1162 # 62f0 <malloc+0x322>
     782:	00005097          	auipc	ra,0x5
     786:	794080e7          	jalr	1940(ra) # 5f16 <printf>
      exit(1);
     78a:	4505                	li	a0,1
     ...
     798:	afc50513          	addi	a0,a0,-1284 # 6290 <malloc+0x2c2>
     79c:	00005097          	auipc	ra,0x5
     7a0:	77a080e7          	jalr	1914(ra) # 5f16 <printf>
      exit(1);
     7a4:	4505                	li	a0,1
     ...
     7b2:	b7250513          	addi	a0,a0,-1166 # 6320 <malloc+0x352>
     7b6:	00005097          	auipc	ra,0x5
     7ba:	760080e7          	jalr	1888(ra) # 5f16 <printf>
      exit(1);
     7be:	4505                	li	a0,1
     ...
     7d0:	b6c50513          	addi	a0,a0,-1172 # 6338 <malloc+0x36a>
     7d4:	00005097          	auipc	ra,0x5
     7d8:	742080e7          	jalr	1858(ra) # 5f16 <printf>
      exit(1);
     7dc:	4505                	li	a0,1
...
00000000000007e6 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     826:	93e58593          	addi	a1,a1,-1730 # 6160 <malloc+0x192>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     842:	91250513          	addi	a0,a0,-1774 # 6150 <malloc+0x182>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     86e:	8e650513          	addi	a0,a0,-1818 # 6150 <malloc+0x182>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     882:	8d250513          	addi	a0,a0,-1838 # 6150 <malloc+0x182>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c0:	b0c58593          	addi	a1,a1,-1268 # 63c8 <malloc+0x3fa>
     8c4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     902:	85250513          	addi	a0,a0,-1966 # 6150 <malloc+0x182>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     946:	a2650513          	addi	a0,a0,-1498 # 6368 <malloc+0x39a>
     94a:	00005097          	auipc	ra,0x5
     94e:	5cc080e7          	jalr	1484(ra) # 5f16 <printf>
    exit(1);
     952:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     962:	a2a50513          	addi	a0,a0,-1494 # 6388 <malloc+0x3ba>
     966:	00005097          	auipc	ra,0x5
     96a:	5b0080e7          	jalr	1456(ra) # 5f16 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     96e:	8652                	mv	a2,s4
     970:	85d6                	mv	a1,s5
     972:	00006517          	auipc	a0,0x6
     976:	a2650513          	addi	a0,a0,-1498 # 6398 <malloc+0x3ca>
     97a:	00005097          	auipc	ra,0x5
     97e:	59c080e7          	jalr	1436(ra) # 5f16 <printf>
    exit(1);
     982:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     992:	a2a50513          	addi	a0,a0,-1494 # 63b8 <malloc+0x3ea>
     996:	00005097          	auipc	ra,0x5
     99a:	580080e7          	jalr	1408(ra) # 5f16 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     99e:	8652                	mv	a2,s4
     9a0:	85d6                	mv	a1,s5
     9a2:	00006517          	auipc	a0,0x6
     9a6:	9f650513          	addi	a0,a0,-1546 # 6398 <malloc+0x3ca>
     9aa:	00005097          	auipc	ra,0x5
     9ae:	56c080e7          	jalr	1388(ra) # 5f16 <printf>
    exit(1);
     9b2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c4:	a1050513          	addi	a0,a0,-1520 # 63d0 <malloc+0x402>
     9c8:	00005097          	auipc	ra,0x5
     9cc:	54e080e7          	jalr	1358(ra) # 5f16 <printf>
    exit(1);
     9d0:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e2:	a1250513          	addi	a0,a0,-1518 # 63f0 <malloc+0x422>
     9e6:	00005097          	auipc	ra,0x5
     9ea:	530080e7          	jalr	1328(ra) # 5f16 <printf>
    exit(1);
     9ee:	4505                	li	a0,1
...
00000000000009f8 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a16:	9fe50513          	addi	a0,a0,-1538 # 6410 <malloc+0x442>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a2e:	a0e98993          	addi	s3,s3,-1522 # 6438 <malloc+0x46a>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a32:	00006a97          	auipc	s5,0x6
     a36:	a3ea8a93          	addi	s5,s5,-1474 # 6470 <malloc+0x4a2>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7c:	99850513          	addi	a0,a0,-1640 # 6410 <malloc+0x442>
  ...
  if(unlink("small") < 0){
     ...
     ab8:	95c50513          	addi	a0,a0,-1700 # 6410 <malloc+0x442>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae2:	93a50513          	addi	a0,a0,-1734 # 6418 <malloc+0x44a>
     ae6:	00005097          	auipc	ra,0x5
     aea:	430080e7          	jalr	1072(ra) # 5f16 <printf>
    exit(1);
     aee:	4505                	li	a0,1
     ...
     b00:	94c50513          	addi	a0,a0,-1716 # 6448 <malloc+0x47a>
     b04:	00005097          	auipc	ra,0x5
     b08:	412080e7          	jalr	1042(ra) # 5f16 <printf>
      exit(1);
     b0c:	4505                	li	a0,1
     ...
     b1e:	96650513          	addi	a0,a0,-1690 # 6480 <malloc+0x4b2>
     b22:	00005097          	auipc	ra,0x5
     b26:	3f4080e7          	jalr	1012(ra) # 5f16 <printf>
      exit(1);
     b2a:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3a:	97250513          	addi	a0,a0,-1678 # 64a8 <malloc+0x4da>
     b3e:	00005097          	auipc	ra,0x5
     b42:	3d8080e7          	jalr	984(ra) # 5f16 <printf>
    exit(1);
     b46:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     b56:	97650513          	addi	a0,a0,-1674 # 64c8 <malloc+0x4fa>
     b5a:	00005097          	auipc	ra,0x5
     b5e:	3bc080e7          	jalr	956(ra) # 5f16 <printf>
    exit(1);
     b62:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b72:	97250513          	addi	a0,a0,-1678 # 64e0 <malloc+0x512>
     b76:	00005097          	auipc	ra,0x5
     b7a:	3a0080e7          	jalr	928(ra) # 5f16 <printf>
    exit(1);
     b7e:	4505                	li	a0,1
...
0000000000000b88 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba4:	96050513          	addi	a0,a0,-1696 # 6500 <malloc+0x532>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf6:	90e50513          	addi	a0,a0,-1778 # 6500 <malloc+0x532>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c3e:	8ce50513          	addi	a0,a0,-1842 # 6508 <malloc+0x53a>
     c42:	00005097          	auipc	ra,0x5
     c46:	2d4080e7          	jalr	724(ra) # 5f16 <printf>
    exit(1);
     c4a:	4505                	li	a0,1
     ...
     c5c:	8d050513          	addi	a0,a0,-1840 # 6528 <malloc+0x55a>
     c60:	00005097          	auipc	ra,0x5
     c64:	2b6080e7          	jalr	694(ra) # 5f16 <printf>
      exit(1);
     c68:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c78:	8dc50513          	addi	a0,a0,-1828 # 6550 <malloc+0x582>
     c7c:	00005097          	auipc	ra,0x5
     c80:	29a080e7          	jalr	666(ra) # 5f16 <printf>
    exit(1);
     c84:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ca4:	86050513          	addi	a0,a0,-1952 # 6500 <malloc+0x532>
     ...
     cd0:	8a450513          	addi	a0,a0,-1884 # 6570 <malloc+0x5a2>
     cd4:	00005097          	auipc	ra,0x5
     cd8:	242080e7          	jalr	578(ra) # 5f16 <printf>
        exit(1);
     cdc:	4505                	li	a0,1
     ...
     cee:	8ae50513          	addi	a0,a0,-1874 # 6598 <malloc+0x5ca>
     cf2:	00005097          	auipc	ra,0x5
     cf6:	224080e7          	jalr	548(ra) # 5f16 <printf>
      exit(1);
     cfa:	4505                	li	a0,1
     ...
     d0c:	8a850513          	addi	a0,a0,-1880 # 65b0 <malloc+0x5e2>
     d10:	00005097          	auipc	ra,0x5
     d14:	206080e7          	jalr	518(ra) # 5f16 <printf>
      exit(1);
     d18:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d28:	8b450513          	addi	a0,a0,-1868 # 65d8 <malloc+0x60a>
     d2c:	00005097          	auipc	ra,0x5
     d30:	1ea080e7          	jalr	490(ra) # 5f16 <printf>
    exit(1);
     d34:	4505                	li	a0,1
...
0000000000000d3e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d56:	89e50513          	addi	a0,a0,-1890 # 65f0 <malloc+0x622>
  ...
  write(fd, "hello", SZ);
     ...
     d6e:	8b658593          	addi	a1,a1,-1866 # 6620 <malloc+0x652>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8a:	86a50513          	addi	a0,a0,-1942 # 65f0 <malloc+0x622>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da0:	85450513          	addi	a0,a0,-1964 # 65f0 <malloc+0x622>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db6:	83e50513          	addi	a0,a0,-1986 # 65f0 <malloc+0x622>
  ...
  write(fd1, "yyy", 3);
     ...
     dca:	8a258593          	addi	a1,a1,-1886 # 6668 <malloc+0x69a>
  ...
  unlink("unlinkread");
     ...
     e32:	7c250513          	addi	a0,a0,1986 # 65f0 <malloc+0x622>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e52:	7b250513          	addi	a0,a0,1970 # 6600 <malloc+0x632>
     e56:	00005097          	auipc	ra,0x5
     e5a:	0c0080e7          	jalr	192(ra) # 5f16 <printf>
    exit(1);
     e5e:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e6e:	7be50513          	addi	a0,a0,1982 # 6628 <malloc+0x65a>
     e72:	00005097          	auipc	ra,0x5
     e76:	0a4080e7          	jalr	164(ra) # 5f16 <printf>
    exit(1);
     e7a:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8a:	7c250513          	addi	a0,a0,1986 # 6648 <malloc+0x67a>
     e8e:	00005097          	auipc	ra,0x5
     e92:	088080e7          	jalr	136(ra) # 5f16 <printf>
    exit(1);
     e96:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea6:	7ce50513          	addi	a0,a0,1998 # 6670 <malloc+0x6a2>
     eaa:	00005097          	auipc	ra,0x5
     eae:	06c080e7          	jalr	108(ra) # 5f16 <printf>
    exit(1);
     eb2:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec2:	7d250513          	addi	a0,a0,2002 # 6690 <malloc+0x6c2>
     ec6:	00005097          	auipc	ra,0x5
     eca:	050080e7          	jalr	80(ra) # 5f16 <printf>
    exit(1);
     ece:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ede:	7d650513          	addi	a0,a0,2006 # 66b0 <malloc+0x6e2>
     ee2:	00005097          	auipc	ra,0x5
     ee6:	034080e7          	jalr	52(ra) # 5f16 <printf>
    exit(1);
     eea:	4505                	li	a0,1
...
0000000000000ef4 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f42:	6e258593          	addi	a1,a1,1762 # 6620 <malloc+0x652>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f62:	77a58593          	addi	a1,a1,1914 # 66d8 <malloc+0x70a>
     f66:	00005517          	auipc	a0,0x5
     f6a:	76a50513          	addi	a0,a0,1898 # 66d0 <malloc+0x702>
  ...
  unlink("lf1");
     ...
     f7e:	75650513          	addi	a0,a0,1878 # 66d0 <malloc+0x702>
     f82:	00005097          	auipc	ra,0x5
     f86:	c5c080e7          	jalr	-932(ra) # 5bde <unlink>
  if(open("lf1", 0) >= 0){
     f8a:	4581                	li	a1,0
     f8c:	00005517          	auipc	a0,0x5
     f90:	74450513          	addi	a0,a0,1860 # 66d0 <malloc+0x702>
  ...
  fd = open("lf2", 0);
     ...
     fa6:	73650513          	addi	a0,a0,1846 # 66d8 <malloc+0x70a>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fde:	6fe58593          	addi	a1,a1,1790 # 66d8 <malloc+0x70a>
     fe2:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff4:	6e850513          	addi	a0,a0,1768 # 66d8 <malloc+0x70a>
     ff8:	00005097          	auipc	ra,0x5
     ffc:	be6080e7          	jalr	-1050(ra) # 5bde <unlink>
  if(link("lf2", "lf1") >= 0){
    1000:	00005597          	auipc	a1,0x5
    1004:	6d058593          	addi	a1,a1,1744 # 66d0 <malloc+0x702>
    1008:	00005517          	auipc	a0,0x5
    100c:	6d050513          	addi	a0,a0,1744 # 66d8 <malloc+0x70a>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1020:	6b458593          	addi	a1,a1,1716 # 66d0 <malloc+0x702>
    1024:	00005517          	auipc	a0,0x5
    1028:	7bc50513          	addi	a0,a0,1980 # 67e0 <malloc+0x812>
    ...
    104a:	69a50513          	addi	a0,a0,1690 # 66e0 <malloc+0x712>
    104e:	00005097          	auipc	ra,0x5
    1052:	ec8080e7          	jalr	-312(ra) # 5f16 <printf>
    exit(1);
    1056:	4505                	li	a0,1
    ...
    1066:	69650513          	addi	a0,a0,1686 # 66f8 <malloc+0x72a>
    106a:	00005097          	auipc	ra,0x5
    106e:	eac080e7          	jalr	-340(ra) # 5f16 <printf>
    exit(1);
    1072:	4505                	li	a0,1
    ...
    1082:	69250513          	addi	a0,a0,1682 # 6710 <malloc+0x742>
    1086:	00005097          	auipc	ra,0x5
    108a:	e90080e7          	jalr	-368(ra) # 5f16 <printf>
    exit(1);
    108e:	4505                	li	a0,1
    ...
    109e:	69650513          	addi	a0,a0,1686 # 6730 <malloc+0x762>
    10a2:	00005097          	auipc	ra,0x5
    10a6:	e74080e7          	jalr	-396(ra) # 5f16 <printf>
    exit(1);
    10aa:	4505                	li	a0,1
    ...
    10ba:	6aa50513          	addi	a0,a0,1706 # 6760 <malloc+0x792>
    10be:	00005097          	auipc	ra,0x5
    10c2:	e58080e7          	jalr	-424(ra) # 5f16 <printf>
    exit(1);
    10c6:	4505                	li	a0,1
    ...
    10d6:	6a650513          	addi	a0,a0,1702 # 6778 <malloc+0x7aa>
    10da:	00005097          	auipc	ra,0x5
    10de:	e3c080e7          	jalr	-452(ra) # 5f16 <printf>
    exit(1);
    10e2:	4505                	li	a0,1
    ...
    10f2:	6a250513          	addi	a0,a0,1698 # 6790 <malloc+0x7c2>
    10f6:	00005097          	auipc	ra,0x5
    10fa:	e20080e7          	jalr	-480(ra) # 5f16 <printf>
    exit(1);
    10fe:	4505                	li	a0,1
    ...
    110e:	6ae50513          	addi	a0,a0,1710 # 67b8 <malloc+0x7ea>
    1112:	00005097          	auipc	ra,0x5
    1116:	e04080e7          	jalr	-508(ra) # 5f16 <printf>
    exit(1);
    111a:	4505                	li	a0,1
    ...
    112a:	6c250513          	addi	a0,a0,1730 # 67e8 <malloc+0x81a>
    112e:	00005097          	auipc	ra,0x5
    1132:	de8080e7          	jalr	-536(ra) # 5f16 <printf>
    exit(1);
    1136:	4505                	li	a0,1
...
0000000000001140 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115c:	6b098993          	addi	s3,s3,1712 # 6808 <malloc+0x83a>
    1160:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1198:	68450513          	addi	a0,a0,1668 # 6818 <malloc+0x84a>
    119c:	00005097          	auipc	ra,0x5
    11a0:	d7a080e7          	jalr	-646(ra) # 5f16 <printf>
      exit(1);
    11a4:	4505                	li	a0,1
...
00000000000011ae <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    11fe:	63ea0a13          	addi	s4,s4,1598 # 6838 <malloc+0x86a>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1250:	5ec50513          	addi	a0,a0,1516 # 6838 <malloc+0x86a>
  ...
  for(i = 0; i < N; i++){
    ...
    12c0:	58450513          	addi	a0,a0,1412 # 6840 <malloc+0x872>
    12c4:	00005097          	auipc	ra,0x5
    12c8:	c52080e7          	jalr	-942(ra) # 5f16 <printf>
    exit(1);
    12cc:	4505                	li	a0,1
    ...
    12e0:	58450513          	addi	a0,a0,1412 # 6860 <malloc+0x892>
    12e4:	00005097          	auipc	ra,0x5
    12e8:	c32080e7          	jalr	-974(ra) # 5f16 <printf>
      exit(1);
    12ec:	4505                	li	a0,1
    ...
    12fc:	58850513          	addi	a0,a0,1416 # 6880 <malloc+0x8b2>
    1300:	00005097          	auipc	ra,0x5
    1304:	c16080e7          	jalr	-1002(ra) # 5f16 <printf>
      exit(1);
    1308:	4505                	li	a0,1
...
000000000000134a <badarg>:
{
    ...
    1368:	d9498993          	addi	s3,s3,-620 # 60f8 <malloc+0x12a>
    argv[0] = (char*)0xffffffff;
...
0000000000001390 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f2:	6ea78793          	addi	a5,a5,1770 # 7ad8 <malloc+0x1b0a>
  ...
  if(pid == 0){
    ...
    144e:	0ce78793          	addi	a5,a5,206 # 8518 <malloc+0x254a>
    ...
    1472:	c8a50513          	addi	a0,a0,-886 # 60f8 <malloc+0x12a>
    ...
    148a:	4a250513          	addi	a0,a0,1186 # 6928 <malloc+0x95a>
    148e:	00005097          	auipc	ra,0x5
    1492:	a88080e7          	jalr	-1400(ra) # 5f16 <printf>
      exit(1);
    1496:	4505                	li	a0,1
    ...
    14aa:	3fa50513          	addi	a0,a0,1018 # 68a0 <malloc+0x8d2>
    14ae:	00005097          	auipc	ra,0x5
    14b2:	a68080e7          	jalr	-1432(ra) # 5f16 <printf>
    exit(1);
    14b6:	4505                	li	a0,1
    ...
    14ca:	3fa50513          	addi	a0,a0,1018 # 68c0 <malloc+0x8f2>
    14ce:	00005097          	auipc	ra,0x5
    14d2:	a48080e7          	jalr	-1464(ra) # 5f16 <printf>
    exit(1);
    14d6:	4505                	li	a0,1
    ...
    14ec:	3f850513          	addi	a0,a0,1016 # 68e0 <malloc+0x912>
    14f0:	00005097          	auipc	ra,0x5
    14f4:	a26080e7          	jalr	-1498(ra) # 5f16 <printf>
    exit(1);
    14f8:	4505                	li	a0,1
    ...
    150c:	40050513          	addi	a0,a0,1024 # 6908 <malloc+0x93a>
    1510:	00005097          	auipc	ra,0x5
    1514:	a06080e7          	jalr	-1530(ra) # 5f16 <printf>
    exit(1);
    1518:	4505                	li	a0,1
    ...
    1526:	86650513          	addi	a0,a0,-1946 # 6d88 <malloc+0xdba>
    152a:	00005097          	auipc	ra,0x5
    152e:	9ec080e7          	jalr	-1556(ra) # 5f16 <printf>
    exit(1);
    1532:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1570:	3e450513          	addi	a0,a0,996 # 6950 <malloc+0x982>
    1574:	00005097          	auipc	ra,0x5
    1578:	9a2080e7          	jalr	-1630(ra) # 5f16 <printf>
    exit(1);
    157c:	4505                	li	a0,1
...
0000000000001586 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15a2:	bb250513          	addi	a0,a0,-1102 # 6150 <malloc+0x182>
  ...
  if(pid == 0){
    ...
    15cc:	b88a0a13          	addi	s4,s4,-1144 # 6150 <malloc+0x182>
      int n = write(fd, "1234567890", 10);
    15d0:	00005a97          	auipc	s5,0x5
    15d4:	3e0a8a93          	addi	s5,s5,992 # 69b0 <malloc+0x9e2>
      int fd = open("truncfile", O_WRONLY);
    15d8:	4585                	li	a1,1
    15da:	8552                	mv	a0,s4
    ...
    1644:	34050513          	addi	a0,a0,832 # 6980 <malloc+0x9b2>
    1648:	00005097          	auipc	ra,0x5
    164c:	8ce080e7          	jalr	-1842(ra) # 5f16 <printf>
    exit(1);
    1650:	4505                	li	a0,1
    ...
    1660:	33c50513          	addi	a0,a0,828 # 6998 <malloc+0x9ca>
    1664:	00005097          	auipc	ra,0x5
    1668:	8b2080e7          	jalr	-1870(ra) # 5f16 <printf>
        exit(1);
    166c:	4505                	li	a0,1
    ...
    167e:	34650513          	addi	a0,a0,838 # 69c0 <malloc+0x9f2>
    1682:	00005097          	auipc	ra,0x5
    1686:	894080e7          	jalr	-1900(ra) # 5f16 <printf>
        exit(1);
    168a:	4505                	li	a0,1
    ...
    169c:	ab8a0a13          	addi	s4,s4,-1352 # 6150 <malloc+0x182>
    int n = write(fd, "xxx", 3);
    16a0:	00005a97          	auipc	s5,0x5
    16a4:	340a8a93          	addi	s5,s5,832 # 69e0 <malloc+0xa12>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16ee:	a6650513          	addi	a0,a0,-1434 # 6150 <malloc+0x182>
  ...
  exit(xstatus);
    ...
    170c:	29050513          	addi	a0,a0,656 # 6998 <malloc+0x9ca>
    1710:	00005097          	auipc	ra,0x5
    1714:	806080e7          	jalr	-2042(ra) # 5f16 <printf>
      exit(1);
    1718:	4505                	li	a0,1
    ...
    172a:	2c250513          	addi	a0,a0,706 # 69e8 <malloc+0xa1a>
    172e:	00004097          	auipc	ra,0x4
    1732:	7e8080e7          	jalr	2024(ra) # 5f16 <printf>
      exit(1);
    1736:	4505                	li	a0,1
...
0000000000001740 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1752:	9aa78793          	addi	a5,a5,-1622 # 60f8 <malloc+0x12a>
    1756:	fcf43023          	sd	a5,-64(s0)
    175a:	00005797          	auipc	a5,0x5
    175e:	2ae78793          	addi	a5,a5,686 # 6a08 <malloc+0xa3a>
    1762:	fcf43423          	sd	a5,-56(s0)
    1766:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    176a:	00005517          	auipc	a0,0x5
    176e:	2a650513          	addi	a0,a0,678 # 6a10 <malloc+0xa42>
  ...
  if(pid == 0) {
    ...
    179c:	27850513          	addi	a0,a0,632 # 6a10 <malloc+0xa42>
    ...
    17b8:	27c50513          	addi	a0,a0,636 # 6a30 <malloc+0xa62>
    17bc:	00004097          	auipc	ra,0x4
    17c0:	75a080e7          	jalr	1882(ra) # 5f16 <printf>
      exit(1);
    17c4:	4505                	li	a0,1
    ...
    17d4:	1b050513          	addi	a0,a0,432 # 6980 <malloc+0x9b2>
    17d8:	00004097          	auipc	ra,0x4
    17dc:	73e080e7          	jalr	1854(ra) # 5f16 <printf>
     exit(1);
    17e0:	4505                	li	a0,1
    ...
    17f0:	22c50513          	addi	a0,a0,556 # 6a18 <malloc+0xa4a>
    17f4:	00004097          	auipc	ra,0x4
    17f8:	722080e7          	jalr	1826(ra) # 5f16 <printf>
      exit(1);
    17fc:	4505                	li	a0,1
    ...
    180e:	8ee50513          	addi	a0,a0,-1810 # 60f8 <malloc+0x12a>
  ...
  if(xstatus != 0)
    ...
    1842:	20250513          	addi	a0,a0,514 # 6a40 <malloc+0xa72>
    1846:	00004097          	auipc	ra,0x4
    184a:	6d0080e7          	jalr	1744(ra) # 5f16 <printf>
      exit(1);
    184e:	4505                	li	a0,1
    ...
    185e:	1fe50513          	addi	a0,a0,510 # 6a58 <malloc+0xa8a>
    1862:	00004097          	auipc	ra,0x4
    1866:	6b4080e7          	jalr	1716(ra) # 5f16 <printf>
    186a:	b7d1                	j	182e <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    186c:	4581                	li	a1,0
    186e:	00005517          	auipc	a0,0x5
    1872:	1a250513          	addi	a0,a0,418 # 6a10 <malloc+0xa42>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    189c:	c3050513          	addi	a0,a0,-976 # 64c8 <malloc+0x4fa>
    18a0:	00004097          	auipc	ra,0x4
    18a4:	676080e7          	jalr	1654(ra) # 5f16 <printf>
    exit(1);
    18a8:	4505                	li	a0,1
    ...
    18b8:	0e450513          	addi	a0,a0,228 # 6998 <malloc+0x9ca>
    18bc:	00004097          	auipc	ra,0x4
    18c0:	65a080e7          	jalr	1626(ra) # 5f16 <printf>
    exit(1);
    18c4:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    18d2:	14250513          	addi	a0,a0,322 # 6a10 <malloc+0xa42>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    18fc:	17850513          	addi	a0,a0,376 # 6a70 <malloc+0xaa2>
    1900:	00004097          	auipc	ra,0x4
    1904:	616080e7          	jalr	1558(ra) # 5f16 <printf>
    exit(1);
    1908:	4505                	li	a0,1
...
000000000000191c <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19bc:	0d050513          	addi	a0,a0,208 # 6a88 <malloc+0xaba>
    19c0:	00004097          	auipc	ra,0x4
    19c4:	556080e7          	jalr	1366(ra) # 5f16 <printf>
    exit(1);
    19c8:	4505                	li	a0,1
    ...
    19f6:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9d>
{
    ...
    1a42:	06250513          	addi	a0,a0,98 # 6aa0 <malloc+0xad2>
    1a46:	00004097          	auipc	ra,0x4
    1a4a:	4d0080e7          	jalr	1232(ra) # 5f16 <printf>
        exit(1);
    1a4e:	4505                	li	a0,1
    ...
    1a5e:	05e50513          	addi	a0,a0,94 # 6ab8 <malloc+0xaea>
    1a62:	00004097          	auipc	ra,0x4
    1a66:	4b4080e7          	jalr	1204(ra) # 5f16 <printf>
}
    ...
    1a90:	04450513          	addi	a0,a0,68 # 6ad0 <malloc+0xb02>
    1a94:	00004097          	auipc	ra,0x4
    1a98:	482080e7          	jalr	1154(ra) # 5f16 <printf>
      exit(1);
    1a9c:	4505                	li	a0,1
    ...
    1ad0:	02450513          	addi	a0,a0,36 # 6af0 <malloc+0xb22>
    1ad4:	00004097          	auipc	ra,0x4
    1ad8:	442080e7          	jalr	1090(ra) # 5f16 <printf>
    exit(1);
    1adc:	4505                	li	a0,1
...
0000000000001ae6 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b42:	e4250513          	addi	a0,a0,-446 # 6980 <malloc+0x9b2>
    1b46:	00004097          	auipc	ra,0x4
    1b4a:	3d0080e7          	jalr	976(ra) # 5f16 <printf>
      exit(1);
    1b4e:	4505                	li	a0,1
    ...
    1b5e:	fae50513          	addi	a0,a0,-82 # 6b08 <malloc+0xb3a>
    1b62:	00004097          	auipc	ra,0x4
    1b66:	3b4080e7          	jalr	948(ra) # 5f16 <printf>
        exit(1);
    1b6a:	4505                	li	a0,1
    ...
    1b7a:	faa50513          	addi	a0,a0,-86 # 6b20 <malloc+0xb52>
    1b7e:	00004097          	auipc	ra,0x4
    1b82:	398080e7          	jalr	920(ra) # 5f16 <printf>
        exit(1);
    1b86:	4505                	li	a0,1
...
0000000000001b9a <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1bf2:	d9250513          	addi	a0,a0,-622 # 6980 <malloc+0x9b2>
    1bf6:	00004097          	auipc	ra,0x4
    1bfa:	320080e7          	jalr	800(ra) # 5f16 <printf>
      exit(1);
    1bfe:	4505                	li	a0,1
    ...
    1c16:	d6e50513          	addi	a0,a0,-658 # 6980 <malloc+0x9b2>
    1c1a:	00004097          	auipc	ra,0x4
    1c1e:	2fc080e7          	jalr	764(ra) # 5f16 <printf>
        exit(1);
    1c22:	4505                	li	a0,1
...
0000000000001c34 <forkfork>:
{
    ...
    1c90:	eb450513          	addi	a0,a0,-332 # 6b40 <malloc+0xb72>
    1c94:	00004097          	auipc	ra,0x4
    1c98:	282080e7          	jalr	642(ra) # 5f16 <printf>
      exit(1);
    1c9c:	4505                	li	a0,1
    ...
    1ca2:	ef0080e7          	jalr	-272(ra) # 5b8e <exit>
{
    ...
    1ce8:	e6c50513          	addi	a0,a0,-404 # 6b50 <malloc+0xb82>
    1cec:	00004097          	auipc	ra,0x4
    1cf0:	22a080e7          	jalr	554(ra) # 5f16 <printf>
      exit(1);
    1cf4:	4505                	li	a0,1
...
0000000000001cfe <reparent2>:
{
  ...
  exit(0);
    ...
    1d36:	05650513          	addi	a0,a0,86 # 6d88 <malloc+0xdba>
    1d3a:	00004097          	auipc	ra,0x4
    1d3e:	1dc080e7          	jalr	476(ra) # 5f16 <printf>
      exit(1);
    1d42:	4505                	li	a0,1
...
0000000000001d66 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1dd4:	fb850513          	addi	a0,a0,-72 # 6d88 <malloc+0xdba>
    1dd8:	00004097          	auipc	ra,0x4
    1ddc:	13e080e7          	jalr	318(ra) # 5f16 <printf>
      exit(1);
    1de0:	4505                	li	a0,1
    ...
    1e00:	c1c50513          	addi	a0,a0,-996 # 6a18 <malloc+0xa4a>
    1e04:	00004097          	auipc	ra,0x4
    1e08:	112080e7          	jalr	274(ra) # 5f16 <printf>
          exit(1);
    1e0c:	4505                	li	a0,1
    ...
    1e72:	d0250513          	addi	a0,a0,-766 # 6b70 <malloc+0xba2>
    1e76:	00004097          	auipc	ra,0x4
    1e7a:	0a0080e7          	jalr	160(ra) # 5f16 <printf>
            exit(1);
    1e7e:	4505                	li	a0,1
    ...
    1ea6:	ce650513          	addi	a0,a0,-794 # 6b88 <malloc+0xbba>
    1eaa:	00004097          	auipc	ra,0x4
    1eae:	06c080e7          	jalr	108(ra) # 5f16 <printf>
        exit(1);
    1eb2:	4505                	li	a0,1
    ...
    1f0c:	ca850513          	addi	a0,a0,-856 # 6bb0 <malloc+0xbe2>
    1f10:	00004097          	auipc	ra,0x4
    1f14:	006080e7          	jalr	6(ra) # 5f16 <printf>
        exit(1);
    1f18:	4505                	li	a0,1
...
0000000000001f8c <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fac:	1c050513          	addi	a0,a0,448 # 6168 <malloc+0x19a>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1fe8:	184a8a93          	addi	s5,s5,388 # 6168 <malloc+0x19a>
      link("cat", "x");
    1fec:	00005b97          	auipc	s7,0x5
    1ff0:	becb8b93          	addi	s7,s7,-1044 # 6bd8 <malloc+0xc0a>
    1ff4:	a825                	j	202c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1ff6:	85a6                	mv	a1,s1
    1ff8:	00005517          	auipc	a0,0x5
    1ffc:	98850513          	addi	a0,a0,-1656 # 6980 <malloc+0x9b2>
    2000:	00004097          	auipc	ra,0x4
    2004:	f16080e7          	jalr	-234(ra) # 5f16 <printf>
    exit(1);
    2008:	4505                	li	a0,1
...
000000000000208e <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20be:	b3e50513          	addi	a0,a0,-1218 # 6bf8 <malloc+0xc2a>
    20c2:	00004097          	auipc	ra,0x4
    20c6:	e54080e7          	jalr	-428(ra) # 5f16 <printf>
    exit(1);
    20ca:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    2120:	ac450513          	addi	a0,a0,-1340 # 6be0 <malloc+0xc12>
    2124:	00004097          	auipc	ra,0x4
    2128:	df2080e7          	jalr	-526(ra) # 5f16 <printf>
    exit(1);
    212c:	4505                	li	a0,1
    ...
    213c:	ae850513          	addi	a0,a0,-1304 # 6c20 <malloc+0xc52>
    2140:	00004097          	auipc	ra,0x4
    2144:	dd6080e7          	jalr	-554(ra) # 5f16 <printf>
      exit(1);
    2148:	4505                	li	a0,1
    ...
    2158:	ae450513          	addi	a0,a0,-1308 # 6c38 <malloc+0xc6a>
    215c:	00004097          	auipc	ra,0x4
    2160:	dba080e7          	jalr	-582(ra) # 5f16 <printf>
    exit(1);
    2164:	4505                	li	a0,1
...
000000000000216e <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21d8:	7ac50513          	addi	a0,a0,1964 # 6980 <malloc+0x9b2>
    21dc:	00004097          	auipc	ra,0x4
    21e0:	d3a080e7          	jalr	-710(ra) # 5f16 <printf>
      exit(1);
    21e4:	4505                	li	a0,1
    ...
    21fa:	a5a50513          	addi	a0,a0,-1446 # 6c50 <malloc+0xc82>
    21fe:	00004097          	auipc	ra,0x4
    2202:	d18080e7          	jalr	-744(ra) # 5f16 <printf>
      exit(1);
    2206:	4505                	li	a0,1
...
000000000000221a <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    227c:	70850513          	addi	a0,a0,1800 # 6980 <malloc+0x9b2>
    2280:	00004097          	auipc	ra,0x4
    2284:	c96080e7          	jalr	-874(ra) # 5f16 <printf>
      exit(1);
    2288:	4505                	li	a0,1
    ...
    22a8:	9cc50513          	addi	a0,a0,-1588 # 6c70 <malloc+0xca2>
    22ac:	00004097          	auipc	ra,0x4
    22b0:	c6a080e7          	jalr	-918(ra) # 5f16 <printf>
      exit(1);
    22b4:	4505                	li	a0,1
...
00000000000022c8 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22d8:	9b450513          	addi	a0,a0,-1612 # 6c88 <malloc+0xcba>
  ...
  fd = open("bigarg-ok", 0);
    ...
    230a:	98250513          	addi	a0,a0,-1662 # 6c88 <malloc+0xcba>
  ...
  close(fd);
    ...
    2340:	95c70713          	addi	a4,a4,-1700 # 6c98 <malloc+0xcca>
    ...
    2394:	9e850513          	addi	a0,a0,-1560 # 6d78 <malloc+0xdaa>
    2398:	00004097          	auipc	ra,0x4
    239c:	b7e080e7          	jalr	-1154(ra) # 5f16 <printf>
    exit(1);
    23a0:	4505                	li	a0,1
    ...
    23b8:	9e450513          	addi	a0,a0,-1564 # 6d98 <malloc+0xdca>
    23bc:	00004097          	auipc	ra,0x4
    23c0:	b5a080e7          	jalr	-1190(ra) # 5f16 <printf>
    exit(1);
    23c4:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2416:	9a650513          	addi	a0,a0,-1626 # 6db8 <malloc+0xdea>
    241a:	00004097          	auipc	ra,0x4
    241e:	afc080e7          	jalr	-1284(ra) # 5f16 <printf>
    exit(1);
    2422:	4505                	li	a0,1
    ...
    2432:	55250513          	addi	a0,a0,1362 # 6980 <malloc+0x9b2>
    2436:	00004097          	auipc	ra,0x4
    243a:	ae0080e7          	jalr	-1312(ra) # 5f16 <printf>
    exit(1);
    243e:	4505                	li	a0,1
...
0000000000002452 <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24a0:	4e450513          	addi	a0,a0,1252 # 6980 <malloc+0x9b2>
    24a4:	00004097          	auipc	ra,0x4
    24a8:	a72080e7          	jalr	-1422(ra) # 5f16 <printf>
    exit(1);
    24ac:	4505                	li	a0,1
...
00000000000024c0 <manywrites>:
{
  ...
  exit(0);
    ...
    251c:	87050513          	addi	a0,a0,-1936 # 6d88 <malloc+0xdba>
    2520:	00004097          	auipc	ra,0x4
    2524:	9f6080e7          	jalr	-1546(ra) # 5f16 <printf>
      exit(1);
    2528:	4505                	li	a0,1
    ...
    25cc:	81850513          	addi	a0,a0,-2024 # 6de0 <malloc+0xe12>
    25d0:	00004097          	auipc	ra,0x4
    25d4:	946080e7          	jalr	-1722(ra) # 5f16 <printf>
            exit(1);
    25d8:	4505                	li	a0,1
    ...
    25ec:	be050513          	addi	a0,a0,-1056 # 61c8 <malloc+0x1fa>
    25f0:	00004097          	auipc	ra,0x4
    25f4:	926080e7          	jalr	-1754(ra) # 5f16 <printf>
            exit(1);
    25f8:	4505                	li	a0,1
...
000000000000260a <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2684:	45878793          	addi	a5,a5,1112 # 7ad8 <malloc+0x1b0a>
  ...
  if(ret != -1){
    ...
    26c6:	73650513          	addi	a0,a0,1846 # 6df8 <malloc+0xe2a>
    26ca:	00004097          	auipc	ra,0x4
    26ce:	84c080e7          	jalr	-1972(ra) # 5f16 <printf>
    exit(1);
    26d2:	4505                	li	a0,1
    ...
    26e4:	1c050513          	addi	a0,a0,448 # 68a0 <malloc+0x8d2>
    26e8:	00004097          	auipc	ra,0x4
    26ec:	82e080e7          	jalr	-2002(ra) # 5f16 <printf>
    exit(1);
    26f0:	4505                	li	a0,1
    ...
    2702:	1c250513          	addi	a0,a0,450 # 68c0 <malloc+0x8f2>
    2706:	00004097          	auipc	ra,0x4
    270a:	810080e7          	jalr	-2032(ra) # 5f16 <printf>
    exit(1);
    270e:	4505                	li	a0,1
    ...
    2722:	1c250513          	addi	a0,a0,450 # 68e0 <malloc+0x912>
    2726:	00003097          	auipc	ra,0x3
    272a:	7f0080e7          	jalr	2032(ra) # 5f16 <printf>
    exit(1);
    272e:	4505                	li	a0,1
    ...
    2740:	1cc50513          	addi	a0,a0,460 # 6908 <malloc+0x93a>
    2744:	00003097          	auipc	ra,0x3
    2748:	7d2080e7          	jalr	2002(ra) # 5f16 <printf>
    exit(1);
    274c:	4505                	li	a0,1
...
0000000000002756 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    278c:	6b050513          	addi	a0,a0,1712 # 6e38 <malloc+0xe6a>
  ...
  if(n >= 0){
    ...
    27bc:	6a050513          	addi	a0,a0,1696 # 6e58 <malloc+0xe8a>
    27c0:	00003097          	auipc	ra,0x3
    27c4:	756080e7          	jalr	1878(ra) # 5f16 <printf>
    exit(1);
    27c8:	4505                	li	a0,1
    ...
    27d6:	62e50513          	addi	a0,a0,1582 # 6e00 <malloc+0xe32>
    27da:	00003097          	auipc	ra,0x3
    27de:	73c080e7          	jalr	1852(ra) # 5f16 <printf>
    exit(1);
    27e2:	4505                	li	a0,1
    ...
    27f0:	62c50513          	addi	a0,a0,1580 # 6e18 <malloc+0xe4a>
    27f4:	00003097          	auipc	ra,0x3
    27f8:	722080e7          	jalr	1826(ra) # 5f16 <printf>
    exit(1);
    27fc:	4505                	li	a0,1
    ...
    280a:	63a50513          	addi	a0,a0,1594 # 6e40 <malloc+0xe72>
    280e:	00003097          	auipc	ra,0x3
    2812:	708080e7          	jalr	1800(ra) # 5f16 <printf>
    exit(1);
    2816:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    282e:	60e50513          	addi	a0,a0,1550 # 6e38 <malloc+0xe6a>
    2832:	00003097          	auipc	ra,0x3
    2836:	3ac080e7          	jalr	940(ra) # 5bde <unlink>
  fd = open("README", O_RDONLY);
    283a:	4581                	li	a1,0
    283c:	00004517          	auipc	a0,0x4
    2840:	a9450513          	addi	a0,a0,-1388 # 62d0 <malloc+0x302>
  ...
  if(n >= 0){
    ...
    286a:	62250513          	addi	a0,a0,1570 # 6e88 <malloc+0xeba>
    286e:	00003097          	auipc	ra,0x3
    2872:	6a8080e7          	jalr	1704(ra) # 5f16 <printf>
    exit(1);
    2876:	4505                	li	a0,1
    ...
    2884:	5c050513          	addi	a0,a0,1472 # 6e40 <malloc+0xe72>
    2888:	00003097          	auipc	ra,0x3
    288c:	68e080e7          	jalr	1678(ra) # 5f16 <printf>
    exit(1);
    2890:	4505                	li	a0,1
...
00000000000028ae <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2904:	5b050513          	addi	a0,a0,1456 # 6eb0 <malloc+0xee2>
    2908:	00003097          	auipc	ra,0x3
    290c:	60e080e7          	jalr	1550(ra) # 5f16 <printf>
    exit(1);
    2910:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2956:	57e50513          	addi	a0,a0,1406 # 6ed0 <malloc+0xf02>
    295a:	00003097          	auipc	ra,0x3
    295e:	5bc080e7          	jalr	1468(ra) # 5f16 <printf>
    exit(1);
    2962:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    29ba:	57a50513          	addi	a0,a0,1402 # 6f30 <malloc+0xf62>
    29be:	00003097          	auipc	ra,0x3
    29c2:	558080e7          	jalr	1368(ra) # 5f16 <printf>
    exit(1);
    29c6:	4505                	li	a0,1
    ...
    29dc:	51850513          	addi	a0,a0,1304 # 6ef0 <malloc+0xf22>
    29e0:	00003097          	auipc	ra,0x3
    29e4:	536080e7          	jalr	1334(ra) # 5f16 <printf>
      exit(1);
    29e8:	4505                	li	a0,1
    ...
    29f8:	51c50513          	addi	a0,a0,1308 # 6f10 <malloc+0xf42>
    29fc:	00003097          	auipc	ra,0x3
    2a00:	51a080e7          	jalr	1306(ra) # 5f16 <printf>
    exit(1);
    2a04:	4505                	li	a0,1
...
0000000000002a34 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2b42:	41250513          	addi	a0,a0,1042 # 6f50 <malloc+0xf82>
    2b46:	00003097          	auipc	ra,0x3
    2b4a:	3d0080e7          	jalr	976(ra) # 5f16 <printf>
    exit(1);
    2b4e:	4505                	li	a0,1
    ...
    2b5e:	43e50513          	addi	a0,a0,1086 # 6f98 <malloc+0xfca>
    2b62:	00003097          	auipc	ra,0x3
    2b66:	3b4080e7          	jalr	948(ra) # 5f16 <printf>
    exit(1);
    2b6a:	4505                	li	a0,1
    ...
    2b7e:	43e50513          	addi	a0,a0,1086 # 6fb8 <malloc+0xfea>
    2b82:	00003097          	auipc	ra,0x3
    2b86:	394080e7          	jalr	916(ra) # 5f16 <printf>
    exit(1);
    2b8a:	4505                	li	a0,1
    ...
    2b9e:	45e50513          	addi	a0,a0,1118 # 6ff8 <malloc+0x102a>
    2ba2:	00003097          	auipc	ra,0x3
    2ba6:	374080e7          	jalr	884(ra) # 5f16 <printf>
    exit(1);
    2baa:	4505                	li	a0,1
    ...
    2bba:	47250513          	addi	a0,a0,1138 # 7028 <malloc+0x105a>
    2bbe:	00003097          	auipc	ra,0x3
    2bc2:	358080e7          	jalr	856(ra) # 5f16 <printf>
    exit(1);
    2bc6:	4505                	li	a0,1
    ...
    2bda:	48a50513          	addi	a0,a0,1162 # 7060 <malloc+0x1092>
    2bde:	00003097          	auipc	ra,0x3
    2be2:	338080e7          	jalr	824(ra) # 5f16 <printf>
    exit(1);
    2be6:	4505                	li	a0,1
...
0000000000002bf0 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c14:	47850513          	addi	a0,a0,1144 # 7088 <malloc+0x10ba>
    2c18:	00003097          	auipc	ra,0x3
    2c1c:	fb6080e7          	jalr	-74(ra) # 5bce <open>
    2c20:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c22:	00004517          	auipc	a0,0x4
    2c26:	46650513          	addi	a0,a0,1126 # 7088 <malloc+0x10ba>
  ...
  if(pipe((int *) a) != 0){
    ...
    2c7a:	41a50513          	addi	a0,a0,1050 # 7090 <malloc+0x10c2>
    2c7e:	00003097          	auipc	ra,0x3
    2c82:	298080e7          	jalr	664(ra) # 5f16 <printf>
    exit(1);
    2c86:	4505                	li	a0,1
    ...
    2c96:	41650513          	addi	a0,a0,1046 # 70a8 <malloc+0x10da>
    2c9a:	00003097          	auipc	ra,0x3
    2c9e:	27c080e7          	jalr	636(ra) # 5f16 <printf>
    exit(1);
    2ca2:	4505                	li	a0,1
    ...
    2cb2:	dda50513          	addi	a0,a0,-550 # 6a88 <malloc+0xaba>
    2cb6:	00003097          	auipc	ra,0x3
    2cba:	260080e7          	jalr	608(ra) # 5f16 <printf>
    exit(1);
    2cbe:	4505                	li	a0,1
...
0000000000002cc8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2cdc:	3e850513          	addi	a0,a0,1000 # 70c0 <malloc+0x10f2>
  ...
  close(fd);
    ...
    2d24:	c7850513          	addi	a0,a0,-904 # 6998 <malloc+0x9ca>
    2d28:	00003097          	auipc	ra,0x3
    2d2c:	1ee080e7          	jalr	494(ra) # 5f16 <printf>
    exit(1);
    2d30:	4505                	li	a0,1
...
0000000000002d3a <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2d72:	01a50513          	addi	a0,a0,26 # 6d88 <malloc+0xdba>
    2d76:	00003097          	auipc	ra,0x3
    2d7a:	1a0080e7          	jalr	416(ra) # 5f16 <printf>
    exit(1);
    2d7e:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2dc8:	fc450513          	addi	a0,a0,-60 # 6d88 <malloc+0xdba>
    2dcc:	00003097          	auipc	ra,0x3
    2dd0:	14a080e7          	jalr	330(ra) # 5f16 <printf>
    exit(1);
    2dd4:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2e28:	f6450513          	addi	a0,a0,-156 # 6d88 <malloc+0xdba>
    2e2c:	00003097          	auipc	ra,0x3
    2e30:	0ea080e7          	jalr	234(ra) # 5f16 <printf>
    exit(1);
    2e34:	4505                	li	a0,1
...
0000000000002f5a <execout>:
{
  ...
  exit(0);
    ...
    2f9c:	df050513          	addi	a0,a0,-528 # 6d88 <malloc+0xdba>
    2fa0:	00003097          	auipc	ra,0x3
    2fa4:	f76080e7          	jalr	-138(ra) # 5f16 <printf>
      exit(1);
    2fa8:	4505                	li	a0,1
    ...
    2ff0:	10c50513          	addi	a0,a0,268 # 60f8 <malloc+0x12a>
    2ff4:	faa43c23          	sd	a0,-72(s0)
    2ff8:	00003797          	auipc	a5,0x3
    2ffc:	17078793          	addi	a5,a5,368 # 6168 <malloc+0x19a>
...
000000000000301e <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    302e:	26e50513          	addi	a0,a0,622 # 7298 <malloc+0x12ca>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3040:	0b450513          	addi	a0,a0,180 # 70f0 <malloc+0x1122>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    3056:	0f650513          	addi	a0,a0,246 # 7148 <malloc+0x117a>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    3074:	15050513          	addi	a0,a0,336 # 71c0 <malloc+0x11f2>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    3090:	1a450513          	addi	a0,a0,420 # 7230 <malloc+0x1262>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30a2:	1ea50513          	addi	a0,a0,490 # 7288 <malloc+0x12ba>
  ...
  unlink("12345678901234");
    ...
    3120:	fac50513          	addi	a0,a0,-84 # 70c8 <malloc+0x10fa>
    3124:	00003097          	auipc	ra,0x3
    3128:	df2080e7          	jalr	-526(ra) # 5f16 <printf>
    exit(1);
    312c:	4505                	li	a0,1
    ...
    313c:	fd850513          	addi	a0,a0,-40 # 7110 <malloc+0x1142>
    3140:	00003097          	auipc	ra,0x3
    3144:	dd6080e7          	jalr	-554(ra) # 5f16 <printf>
    exit(1);
    3148:	4505                	li	a0,1
    ...
    3158:	02450513          	addi	a0,a0,36 # 7178 <malloc+0x11aa>
    315c:	00003097          	auipc	ra,0x3
    3160:	dba080e7          	jalr	-582(ra) # 5f16 <printf>
    exit(1);
    3164:	4505                	li	a0,1
    ...
    3174:	08050513          	addi	a0,a0,128 # 71f0 <malloc+0x1222>
    3178:	00003097          	auipc	ra,0x3
    317c:	d9e080e7          	jalr	-610(ra) # 5f16 <printf>
    exit(1);
    3180:	4505                	li	a0,1
    ...
    3190:	0c450513          	addi	a0,a0,196 # 7250 <malloc+0x1282>
    3194:	00003097          	auipc	ra,0x3
    3198:	d82080e7          	jalr	-638(ra) # 5f16 <printf>
    exit(1);
    319c:	4505                	li	a0,1
    ...
    31ac:	10050513          	addi	a0,a0,256 # 72a8 <malloc+0x12da>
    31b0:	00003097          	auipc	ra,0x3
    31b4:	d66080e7          	jalr	-666(ra) # 5f16 <printf>
    exit(1);
    31b8:	4505                	li	a0,1
...
00000000000031c2 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    31f8:	0ec50513          	addi	a0,a0,236 # 72e0 <malloc+0x1312>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3222:	0d250513          	addi	a0,a0,210 # 72f0 <malloc+0x1322>
    3226:	00003097          	auipc	ra,0x3
    322a:	cf0080e7          	jalr	-784(ra) # 5f16 <printf>
      break;
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    32b2:	03250513          	addi	a0,a0,50 # 72e0 <malloc+0x1312>
  ...
  unlink("diskfulldir");
    ...
    32c6:	01e50513          	addi	a0,a0,30 # 72e0 <malloc+0x1312>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    33f4:	f2050513          	addi	a0,a0,-224 # 7310 <malloc+0x1342>
    33f8:	00003097          	auipc	ra,0x3
    33fc:	b1e080e7          	jalr	-1250(ra) # 5f16 <printf>
...
0000000000003402 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3412:	f3250513          	addi	a0,a0,-206 # 7340 <malloc+0x1372>
  ...
  if(chdir("iputdir") < 0){
    ...
    3426:	f1e50513          	addi	a0,a0,-226 # 7340 <malloc+0x1372>
  ...
  if(unlink("../iputdir") < 0){
    ...
    343a:	f4a50513          	addi	a0,a0,-182 # 7380 <malloc+0x13b2>
  ...
  if(chdir("/") < 0){
    ...
    344e:	f6650513          	addi	a0,a0,-154 # 73b0 <malloc+0x13e2>
    ...
    346e:	ede50513          	addi	a0,a0,-290 # 7348 <malloc+0x137a>
    3472:	00003097          	auipc	ra,0x3
    3476:	aa4080e7          	jalr	-1372(ra) # 5f16 <printf>
    exit(1);
    347a:	4505                	li	a0,1
    ...
    348a:	eda50513          	addi	a0,a0,-294 # 7360 <malloc+0x1392>
    348e:	00003097          	auipc	ra,0x3
    3492:	a88080e7          	jalr	-1400(ra) # 5f16 <printf>
    exit(1);
    3496:	4505                	li	a0,1
    ...
    34a6:	eee50513          	addi	a0,a0,-274 # 7390 <malloc+0x13c2>
    34aa:	00003097          	auipc	ra,0x3
    34ae:	a6c080e7          	jalr	-1428(ra) # 5f16 <printf>
    exit(1);
    34b2:	4505                	li	a0,1
    ...
    34c2:	efa50513          	addi	a0,a0,-262 # 73b8 <malloc+0x13ea>
    34c6:	00003097          	auipc	ra,0x3
    34ca:	a50080e7          	jalr	-1456(ra) # 5f16 <printf>
    exit(1);
    34ce:	4505                	li	a0,1
...
00000000000034d8 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    34f6:	e4e50513          	addi	a0,a0,-434 # 7340 <malloc+0x1372>
    ...
    350a:	e3a50513          	addi	a0,a0,-454 # 7340 <malloc+0x1372>
    ...
    351e:	e6650513          	addi	a0,a0,-410 # 7380 <malloc+0x13b2>
    ...
    353e:	44650513          	addi	a0,a0,1094 # 6980 <malloc+0x9b2>
    3542:	00003097          	auipc	ra,0x3
    3546:	9d4080e7          	jalr	-1580(ra) # 5f16 <printf>
    exit(1);
    354a:	4505                	li	a0,1
    ...
    355a:	df250513          	addi	a0,a0,-526 # 7348 <malloc+0x137a>
    355e:	00003097          	auipc	ra,0x3
    3562:	9b8080e7          	jalr	-1608(ra) # 5f16 <printf>
      exit(1);
    3566:	4505                	li	a0,1
    ...
    3576:	e5e50513          	addi	a0,a0,-418 # 73d0 <malloc+0x1402>
    357a:	00003097          	auipc	ra,0x3
    357e:	99c080e7          	jalr	-1636(ra) # 5f16 <printf>
      exit(1);
    3582:	4505                	li	a0,1
    ...
    3592:	e0250513          	addi	a0,a0,-510 # 7390 <malloc+0x13c2>
    3596:	00003097          	auipc	ra,0x3
    359a:	980080e7          	jalr	-1664(ra) # 5f16 <printf>
      exit(1);
    359e:	4505                	li	a0,1
...
00000000000035c0 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35d0:	e1c50513          	addi	a0,a0,-484 # 73e8 <malloc+0x141a>
  ...
  if(chdir("dir0") < 0){
    ...
    35e4:	e0850513          	addi	a0,a0,-504 # 73e8 <malloc+0x141a>
  ...
  if(chdir("..") < 0){
    ...
    35f8:	e1450513          	addi	a0,a0,-492 # 7408 <malloc+0x143a>
  ...
  if(unlink("dir0") < 0){
    ...
    360c:	de050513          	addi	a0,a0,-544 # 73e8 <malloc+0x141a>
    ...
    362c:	d2050513          	addi	a0,a0,-736 # 7348 <malloc+0x137a>
    3630:	00003097          	auipc	ra,0x3
    3634:	8e6080e7          	jalr	-1818(ra) # 5f16 <printf>
    exit(1);
    3638:	4505                	li	a0,1
    ...
    3648:	dac50513          	addi	a0,a0,-596 # 73f0 <malloc+0x1422>
    364c:	00003097          	auipc	ra,0x3
    3650:	8ca080e7          	jalr	-1846(ra) # 5f16 <printf>
    exit(1);
    3654:	4505                	li	a0,1
    ...
    3664:	db050513          	addi	a0,a0,-592 # 7410 <malloc+0x1442>
    3668:	00003097          	auipc	ra,0x3
    366c:	8ae080e7          	jalr	-1874(ra) # 5f16 <printf>
    exit(1);
    3670:	4505                	li	a0,1
    ...
    3680:	dac50513          	addi	a0,a0,-596 # 7428 <malloc+0x145a>
    3684:	00003097          	auipc	ra,0x3
    3688:	892080e7          	jalr	-1902(ra) # 5f16 <printf>
    exit(1);
    368c:	4505                	li	a0,1
...
0000000000003696 <subdir>:
{
  ...
  unlink("ff");
    ...
    36a8:	ecc50513          	addi	a0,a0,-308 # 7570 <malloc+0x15a2>
    36ac:	00002097          	auipc	ra,0x2
    36b0:	532080e7          	jalr	1330(ra) # 5bde <unlink>
  if(mkdir("dd") != 0){
    36b4:	00004517          	auipc	a0,0x4
    36b8:	d8c50513          	addi	a0,a0,-628 # 7440 <malloc+0x1472>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36d0:	d9450513          	addi	a0,a0,-620 # 7460 <malloc+0x1492>
  ...
  write(fd, "ff", 2);
    ...
    36e8:	e8c58593          	addi	a1,a1,-372 # 7570 <malloc+0x15a2>
  ...
  if(unlink("dd") >= 0){
    ...
    3702:	d4250513          	addi	a0,a0,-702 # 7440 <malloc+0x1472>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3716:	da650513          	addi	a0,a0,-602 # 74b8 <malloc+0x14ea>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    372e:	db650513          	addi	a0,a0,-586 # 74e0 <malloc+0x1512>
  ...
  write(fd, "FF", 2);
    ...
    3746:	dce58593          	addi	a1,a1,-562 # 7510 <malloc+0x1542>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3762:	dba50513          	addi	a0,a0,-582 # 7518 <malloc+0x154a>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37aa:	dc258593          	addi	a1,a1,-574 # 7568 <malloc+0x159a>
    37ae:	00004517          	auipc	a0,0x4
    37b2:	d3250513          	addi	a0,a0,-718 # 74e0 <malloc+0x1512>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    37c6:	d1e50513          	addi	a0,a0,-738 # 74e0 <malloc+0x1512>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    37dc:	d0850513          	addi	a0,a0,-760 # 74e0 <malloc+0x1512>
  ...
  if(chdir("dd") != 0){
    ...
    37f0:	c5450513          	addi	a0,a0,-940 # 7440 <malloc+0x1472>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3804:	e0050513          	addi	a0,a0,-512 # 7600 <malloc+0x1632>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3818:	e1c50513          	addi	a0,a0,-484 # 7630 <malloc+0x1662>
  ...
  if(chdir("./..") != 0){
    ...
    382c:	e3850513          	addi	a0,a0,-456 # 7660 <malloc+0x1692>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3842:	d2a50513          	addi	a0,a0,-726 # 7568 <malloc+0x159a>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    387c:	c6850513          	addi	a0,a0,-920 # 74e0 <malloc+0x1512>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3894:	e6050513          	addi	a0,a0,-416 # 76f0 <malloc+0x1722>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38ac:	e7850513          	addi	a0,a0,-392 # 7720 <malloc+0x1752>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    38c4:	b8050513          	addi	a0,a0,-1152 # 7440 <malloc+0x1472>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    38da:	b6a50513          	addi	a0,a0,-1174 # 7440 <malloc+0x1472>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    38f0:	b5450513          	addi	a0,a0,-1196 # 7440 <malloc+0x1472>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3904:	eb058593          	addi	a1,a1,-336 # 77b0 <malloc+0x17e2>
    3908:	00004517          	auipc	a0,0x4
    390c:	de850513          	addi	a0,a0,-536 # 76f0 <malloc+0x1722>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3920:	e9458593          	addi	a1,a1,-364 # 77b0 <malloc+0x17e2>
    3924:	00004517          	auipc	a0,0x4
    3928:	dfc50513          	addi	a0,a0,-516 # 7720 <malloc+0x1752>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    393c:	c3058593          	addi	a1,a1,-976 # 7568 <malloc+0x159a>
    3940:	00004517          	auipc	a0,0x4
    3944:	b2050513          	addi	a0,a0,-1248 # 7460 <malloc+0x1492>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3958:	d9c50513          	addi	a0,a0,-612 # 76f0 <malloc+0x1722>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    396c:	db850513          	addi	a0,a0,-584 # 7720 <malloc+0x1752>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3980:	bec50513          	addi	a0,a0,-1044 # 7568 <malloc+0x159a>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3994:	d9050513          	addi	a0,a0,-624 # 7720 <malloc+0x1752>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39a8:	d4c50513          	addi	a0,a0,-692 # 76f0 <malloc+0x1722>
  ...
  if(chdir("dd/ff") == 0){
    ...
    39bc:	aa850513          	addi	a0,a0,-1368 # 7460 <malloc+0x1492>
  ...
  if(chdir("dd/xx") == 0){
    ...
    39d0:	f3450513          	addi	a0,a0,-204 # 7900 <malloc+0x1932>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    39e4:	b8850513          	addi	a0,a0,-1144 # 7568 <malloc+0x159a>
  ...
  if(unlink("dd/ff") != 0){
    ...
    39f8:	a6c50513          	addi	a0,a0,-1428 # 7460 <malloc+0x1492>
  ...
  if(unlink("dd") == 0){
    ...
    3a0c:	a3850513          	addi	a0,a0,-1480 # 7440 <malloc+0x1472>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a20:	f5450513          	addi	a0,a0,-172 # 7970 <malloc+0x19a2>
  ...
  if(unlink("dd") < 0){
    ...
    3a34:	a1050513          	addi	a0,a0,-1520 # 7440 <malloc+0x1472>
    ...
    3a56:	9f650513          	addi	a0,a0,-1546 # 7448 <malloc+0x147a>
    3a5a:	00002097          	auipc	ra,0x2
    3a5e:	4bc080e7          	jalr	1212(ra) # 5f16 <printf>
    exit(1);
    3a62:	4505                	li	a0,1
    ...
    3a72:	9fa50513          	addi	a0,a0,-1542 # 7468 <malloc+0x149a>
    3a76:	00002097          	auipc	ra,0x2
    3a7a:	4a0080e7          	jalr	1184(ra) # 5f16 <printf>
    exit(1);
    3a7e:	4505                	li	a0,1
    ...
    3a8e:	9fe50513          	addi	a0,a0,-1538 # 7488 <malloc+0x14ba>
    3a92:	00002097          	auipc	ra,0x2
    3a96:	484080e7          	jalr	1156(ra) # 5f16 <printf>
    exit(1);
    3a9a:	4505                	li	a0,1
    ...
    3aaa:	a1a50513          	addi	a0,a0,-1510 # 74c0 <malloc+0x14f2>
    3aae:	00002097          	auipc	ra,0x2
    3ab2:	468080e7          	jalr	1128(ra) # 5f16 <printf>
    exit(1);
    3ab6:	4505                	li	a0,1
    ...
    3ac6:	a2e50513          	addi	a0,a0,-1490 # 74f0 <malloc+0x1522>
    3aca:	00002097          	auipc	ra,0x2
    3ace:	44c080e7          	jalr	1100(ra) # 5f16 <printf>
    exit(1);
    3ad2:	4505                	li	a0,1
    ...
    3ae2:	a4a50513          	addi	a0,a0,-1462 # 7528 <malloc+0x155a>
    3ae6:	00002097          	auipc	ra,0x2
    3aea:	430080e7          	jalr	1072(ra) # 5f16 <printf>
    exit(1);
    3aee:	4505                	li	a0,1
    ...
    3afe:	a4e50513          	addi	a0,a0,-1458 # 7548 <malloc+0x157a>
    3b02:	00002097          	auipc	ra,0x2
    3b06:	414080e7          	jalr	1044(ra) # 5f16 <printf>
    exit(1);
    3b0a:	4505                	li	a0,1
    ...
    3b1a:	a6250513          	addi	a0,a0,-1438 # 7578 <malloc+0x15aa>
    3b1e:	00002097          	auipc	ra,0x2
    3b22:	3f8080e7          	jalr	1016(ra) # 5f16 <printf>
    exit(1);
    3b26:	4505                	li	a0,1
    ...
    3b36:	a6e50513          	addi	a0,a0,-1426 # 75a0 <malloc+0x15d2>
    3b3a:	00002097          	auipc	ra,0x2
    3b3e:	3dc080e7          	jalr	988(ra) # 5f16 <printf>
    exit(1);
    3b42:	4505                	li	a0,1
    ...
    3b52:	a7250513          	addi	a0,a0,-1422 # 75c0 <malloc+0x15f2>
    3b56:	00002097          	auipc	ra,0x2
    3b5a:	3c0080e7          	jalr	960(ra) # 5f16 <printf>
    exit(1);
    3b5e:	4505                	li	a0,1
    ...
    3b6e:	a7e50513          	addi	a0,a0,-1410 # 75e8 <malloc+0x161a>
    3b72:	00002097          	auipc	ra,0x2
    3b76:	3a4080e7          	jalr	932(ra) # 5f16 <printf>
    exit(1);
    3b7a:	4505                	li	a0,1
    ...
    3b8a:	a8a50513          	addi	a0,a0,-1398 # 7610 <malloc+0x1642>
    3b8e:	00002097          	auipc	ra,0x2
    3b92:	388080e7          	jalr	904(ra) # 5f16 <printf>
    exit(1);
    3b96:	4505                	li	a0,1
    ...
    3ba6:	a9e50513          	addi	a0,a0,-1378 # 7640 <malloc+0x1672>
    3baa:	00002097          	auipc	ra,0x2
    3bae:	36c080e7          	jalr	876(ra) # 5f16 <printf>
    exit(1);
    3bb2:	4505                	li	a0,1
    ...
    3bc2:	aaa50513          	addi	a0,a0,-1366 # 7668 <malloc+0x169a>
    3bc6:	00002097          	auipc	ra,0x2
    3bca:	350080e7          	jalr	848(ra) # 5f16 <printf>
    exit(1);
    3bce:	4505                	li	a0,1
    ...
    3bde:	aa650513          	addi	a0,a0,-1370 # 7680 <malloc+0x16b2>
    3be2:	00002097          	auipc	ra,0x2
    3be6:	334080e7          	jalr	820(ra) # 5f16 <printf>
    exit(1);
    3bea:	4505                	li	a0,1
    ...
    3bfa:	aaa50513          	addi	a0,a0,-1366 # 76a0 <malloc+0x16d2>
    3bfe:	00002097          	auipc	ra,0x2
    3c02:	318080e7          	jalr	792(ra) # 5f16 <printf>
    exit(1);
    3c06:	4505                	li	a0,1
    ...
    3c16:	aae50513          	addi	a0,a0,-1362 # 76c0 <malloc+0x16f2>
    3c1a:	00002097          	auipc	ra,0x2
    3c1e:	2fc080e7          	jalr	764(ra) # 5f16 <printf>
    exit(1);
    3c22:	4505                	li	a0,1
    ...
    3c32:	ad250513          	addi	a0,a0,-1326 # 7700 <malloc+0x1732>
    3c36:	00002097          	auipc	ra,0x2
    3c3a:	2e0080e7          	jalr	736(ra) # 5f16 <printf>
    exit(1);
    3c3e:	4505                	li	a0,1
    ...
    3c4e:	ae650513          	addi	a0,a0,-1306 # 7730 <malloc+0x1762>
    3c52:	00002097          	auipc	ra,0x2
    3c56:	2c4080e7          	jalr	708(ra) # 5f16 <printf>
    exit(1);
    3c5a:	4505                	li	a0,1
    ...
    3c6a:	aea50513          	addi	a0,a0,-1302 # 7750 <malloc+0x1782>
    3c6e:	00002097          	auipc	ra,0x2
    3c72:	2a8080e7          	jalr	680(ra) # 5f16 <printf>
    exit(1);
    3c76:	4505                	li	a0,1
    ...
    3c86:	aee50513          	addi	a0,a0,-1298 # 7770 <malloc+0x17a2>
    3c8a:	00002097          	auipc	ra,0x2
    3c8e:	28c080e7          	jalr	652(ra) # 5f16 <printf>
    exit(1);
    3c92:	4505                	li	a0,1
    ...
    3ca2:	af250513          	addi	a0,a0,-1294 # 7790 <malloc+0x17c2>
    3ca6:	00002097          	auipc	ra,0x2
    3caa:	270080e7          	jalr	624(ra) # 5f16 <printf>
    exit(1);
    3cae:	4505                	li	a0,1
    ...
    3cbe:	b0650513          	addi	a0,a0,-1274 # 77c0 <malloc+0x17f2>
    3cc2:	00002097          	auipc	ra,0x2
    3cc6:	254080e7          	jalr	596(ra) # 5f16 <printf>
    exit(1);
    3cca:	4505                	li	a0,1
    ...
    3cda:	b1250513          	addi	a0,a0,-1262 # 77e8 <malloc+0x181a>
    3cde:	00002097          	auipc	ra,0x2
    3ce2:	238080e7          	jalr	568(ra) # 5f16 <printf>
    exit(1);
    3ce6:	4505                	li	a0,1
    ...
    3cf6:	b1e50513          	addi	a0,a0,-1250 # 7810 <malloc+0x1842>
    3cfa:	00002097          	auipc	ra,0x2
    3cfe:	21c080e7          	jalr	540(ra) # 5f16 <printf>
    exit(1);
    3d02:	4505                	li	a0,1
    ...
    3d12:	b2a50513          	addi	a0,a0,-1238 # 7838 <malloc+0x186a>
    3d16:	00002097          	auipc	ra,0x2
    3d1a:	200080e7          	jalr	512(ra) # 5f16 <printf>
    exit(1);
    3d1e:	4505                	li	a0,1
    ...
    3d2e:	b2e50513          	addi	a0,a0,-1234 # 7858 <malloc+0x188a>
    3d32:	00002097          	auipc	ra,0x2
    3d36:	1e4080e7          	jalr	484(ra) # 5f16 <printf>
    exit(1);
    3d3a:	4505                	li	a0,1
    ...
    3d4a:	b3250513          	addi	a0,a0,-1230 # 7878 <malloc+0x18aa>
    3d4e:	00002097          	auipc	ra,0x2
    3d52:	1c8080e7          	jalr	456(ra) # 5f16 <printf>
    exit(1);
    3d56:	4505                	li	a0,1
    ...
    3d66:	b3e50513          	addi	a0,a0,-1218 # 78a0 <malloc+0x18d2>
    3d6a:	00002097          	auipc	ra,0x2
    3d6e:	1ac080e7          	jalr	428(ra) # 5f16 <printf>
    exit(1);
    3d72:	4505                	li	a0,1
    ...
    3d82:	b4250513          	addi	a0,a0,-1214 # 78c0 <malloc+0x18f2>
    3d86:	00002097          	auipc	ra,0x2
    3d8a:	190080e7          	jalr	400(ra) # 5f16 <printf>
    exit(1);
    3d8e:	4505                	li	a0,1
    ...
    3d9e:	b4650513          	addi	a0,a0,-1210 # 78e0 <malloc+0x1912>
    3da2:	00002097          	auipc	ra,0x2
    3da6:	174080e7          	jalr	372(ra) # 5f16 <printf>
    exit(1);
    3daa:	4505                	li	a0,1
    ...
    3dba:	b5250513          	addi	a0,a0,-1198 # 7908 <malloc+0x193a>
    3dbe:	00002097          	auipc	ra,0x2
    3dc2:	158080e7          	jalr	344(ra) # 5f16 <printf>
    exit(1);
    3dc6:	4505                	li	a0,1
    ...
    3dd6:	7ce50513          	addi	a0,a0,1998 # 75a0 <malloc+0x15d2>
    3dda:	00002097          	auipc	ra,0x2
    3dde:	13c080e7          	jalr	316(ra) # 5f16 <printf>
    exit(1);
    3de2:	4505                	li	a0,1
    ...
    3df2:	b3a50513          	addi	a0,a0,-1222 # 7928 <malloc+0x195a>
    3df6:	00002097          	auipc	ra,0x2
    3dfa:	120080e7          	jalr	288(ra) # 5f16 <printf>
    exit(1);
    3dfe:	4505                	li	a0,1
    ...
    3e0e:	b3e50513          	addi	a0,a0,-1218 # 7948 <malloc+0x197a>
    3e12:	00002097          	auipc	ra,0x2
    3e16:	104080e7          	jalr	260(ra) # 5f16 <printf>
    exit(1);
    3e1a:	4505                	li	a0,1
    ...
    3e2a:	b5250513          	addi	a0,a0,-1198 # 7978 <malloc+0x19aa>
    3e2e:	00002097          	auipc	ra,0x2
    3e32:	0e8080e7          	jalr	232(ra) # 5f16 <printf>
    exit(1);
    3e36:	4505                	li	a0,1
    ...
    3e46:	b5650513          	addi	a0,a0,-1194 # 7998 <malloc+0x19ca>
    3e4a:	00002097          	auipc	ra,0x2
    3e4e:	0cc080e7          	jalr	204(ra) # 5f16 <printf>
    exit(1);
    3e52:	4505                	li	a0,1
...
0000000000003e5c <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e6c:	b4850513          	addi	a0,a0,-1208 # 79b0 <malloc+0x19e2>
  ...
  if(chdir("dots") != 0){
    ...
    3e7e:	b3650513          	addi	a0,a0,-1226 # 79b0 <malloc+0x19e2>
  ...
  if(unlink(".") == 0){
    ...
    3e90:	95450513          	addi	a0,a0,-1708 # 67e0 <malloc+0x812>
  ...
  if(unlink("..") == 0){
    ...
    3ea2:	56a50513          	addi	a0,a0,1386 # 7408 <malloc+0x143a>
  ...
  if(chdir("/") != 0){
    ...
    3eb4:	50050513          	addi	a0,a0,1280 # 73b0 <malloc+0x13e2>
  ...
  if(unlink("dots/.") == 0){
    ...
    3ec6:	b5650513          	addi	a0,a0,-1194 # 7a18 <malloc+0x1a4a>
  ...
  if(unlink("dots/..") == 0){
    ...
    3ed8:	b6c50513          	addi	a0,a0,-1172 # 7a40 <malloc+0x1a72>
  ...
  if(unlink("dots") != 0){
    ...
    3eea:	aca50513          	addi	a0,a0,-1334 # 79b0 <malloc+0x19e2>
    ...
    3f08:	ab450513          	addi	a0,a0,-1356 # 79b8 <malloc+0x19ea>
    3f0c:	00002097          	auipc	ra,0x2
    3f10:	00a080e7          	jalr	10(ra) # 5f16 <printf>
    exit(1);
    3f14:	4505                	li	a0,1
    ...
    3f24:	ab050513          	addi	a0,a0,-1360 # 79d0 <malloc+0x1a02>
    3f28:	00002097          	auipc	ra,0x2
    3f2c:	fee080e7          	jalr	-18(ra) # 5f16 <printf>
    exit(1);
    3f30:	4505                	li	a0,1
    ...
    3f40:	aac50513          	addi	a0,a0,-1364 # 79e8 <malloc+0x1a1a>
    3f44:	00002097          	auipc	ra,0x2
    3f48:	fd2080e7          	jalr	-46(ra) # 5f16 <printf>
    exit(1);
    3f4c:	4505                	li	a0,1
    ...
    3f5c:	aa850513          	addi	a0,a0,-1368 # 7a00 <malloc+0x1a32>
    3f60:	00002097          	auipc	ra,0x2
    3f64:	fb6080e7          	jalr	-74(ra) # 5f16 <printf>
    exit(1);
    3f68:	4505                	li	a0,1
    ...
    3f78:	44450513          	addi	a0,a0,1092 # 73b8 <malloc+0x13ea>
    3f7c:	00002097          	auipc	ra,0x2
    3f80:	f9a080e7          	jalr	-102(ra) # 5f16 <printf>
    exit(1);
    3f84:	4505                	li	a0,1
    ...
    3f94:	a9050513          	addi	a0,a0,-1392 # 7a20 <malloc+0x1a52>
    3f98:	00002097          	auipc	ra,0x2
    3f9c:	f7e080e7          	jalr	-130(ra) # 5f16 <printf>
    exit(1);
    3fa0:	4505                	li	a0,1
    ...
    3fb0:	a9c50513          	addi	a0,a0,-1380 # 7a48 <malloc+0x1a7a>
    3fb4:	00002097          	auipc	ra,0x2
    3fb8:	f62080e7          	jalr	-158(ra) # 5f16 <printf>
    exit(1);
    3fbc:	4505                	li	a0,1
    ...
    3fcc:	aa050513          	addi	a0,a0,-1376 # 7a68 <malloc+0x1a9a>
    3fd0:	00002097          	auipc	ra,0x2
    3fd4:	f46080e7          	jalr	-186(ra) # 5f16 <printf>
    exit(1);
    3fd8:	4505                	li	a0,1
...
0000000000003fe2 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3ff8:	a9450513          	addi	a0,a0,-1388 # 7a88 <malloc+0x1aba>
  ...
  if(chdir("dirfile") == 0){
    ...
    4014:	a7850513          	addi	a0,a0,-1416 # 7a88 <malloc+0x1aba>
  ...
  fd = open("dirfile/xx", 0);
    ...
    4028:	aac50513          	addi	a0,a0,-1364 # 7ad0 <malloc+0x1b02>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4040:	a9450513          	addi	a0,a0,-1388 # 7ad0 <malloc+0x1b02>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    4054:	a8050513          	addi	a0,a0,-1408 # 7ad0 <malloc+0x1b02>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    4068:	a6c50513          	addi	a0,a0,-1428 # 7ad0 <malloc+0x1b02>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    407c:	a5858593          	addi	a1,a1,-1448 # 7ad0 <malloc+0x1b02>
    4080:	00002517          	auipc	a0,0x2
    4084:	25050513          	addi	a0,a0,592 # 62d0 <malloc+0x302>
  ...
  if(unlink("dirfile") != 0){
    ...
    4098:	9f450513          	addi	a0,a0,-1548 # 7a88 <malloc+0x1aba>
  ...
  fd = open(".", O_RDWR);
    ...
    40ae:	73650513          	addi	a0,a0,1846 # 67e0 <malloc+0x812>
  ...
  fd = open(".", 0);
    ...
    40c4:	72050513          	addi	a0,a0,1824 # 67e0 <malloc+0x812>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    40d8:	09458593          	addi	a1,a1,148 # 6168 <malloc+0x19a>
  ...
  close(fd);
    ...
    4104:	99050513          	addi	a0,a0,-1648 # 7a90 <malloc+0x1ac2>
    4108:	00002097          	auipc	ra,0x2
    410c:	e0e080e7          	jalr	-498(ra) # 5f16 <printf>
    exit(1);
    4110:	4505                	li	a0,1
    ...
    4120:	99450513          	addi	a0,a0,-1644 # 7ab0 <malloc+0x1ae2>
    4124:	00002097          	auipc	ra,0x2
    4128:	df2080e7          	jalr	-526(ra) # 5f16 <printf>
    exit(1);
    412c:	4505                	li	a0,1
    ...
    413c:	9a850513          	addi	a0,a0,-1624 # 7ae0 <malloc+0x1b12>
    4140:	00002097          	auipc	ra,0x2
    4144:	dd6080e7          	jalr	-554(ra) # 5f16 <printf>
    exit(1);
    4148:	4505                	li	a0,1
    ...
    4158:	98c50513          	addi	a0,a0,-1652 # 7ae0 <malloc+0x1b12>
    415c:	00002097          	auipc	ra,0x2
    4160:	dba080e7          	jalr	-582(ra) # 5f16 <printf>
    exit(1);
    4164:	4505                	li	a0,1
    ...
    4174:	99850513          	addi	a0,a0,-1640 # 7b08 <malloc+0x1b3a>
    4178:	00002097          	auipc	ra,0x2
    417c:	d9e080e7          	jalr	-610(ra) # 5f16 <printf>
    exit(1);
    4180:	4505                	li	a0,1
    ...
    4190:	9a450513          	addi	a0,a0,-1628 # 7b30 <malloc+0x1b62>
    4194:	00002097          	auipc	ra,0x2
    4198:	d82080e7          	jalr	-638(ra) # 5f16 <printf>
    exit(1);
    419c:	4505                	li	a0,1
    ...
    41ac:	9b050513          	addi	a0,a0,-1616 # 7b58 <malloc+0x1b8a>
    41b0:	00002097          	auipc	ra,0x2
    41b4:	d66080e7          	jalr	-666(ra) # 5f16 <printf>
    exit(1);
    41b8:	4505                	li	a0,1
    ...
    41c8:	9bc50513          	addi	a0,a0,-1604 # 7b80 <malloc+0x1bb2>
    41cc:	00002097          	auipc	ra,0x2
    41d0:	d4a080e7          	jalr	-694(ra) # 5f16 <printf>
    exit(1);
    41d4:	4505                	li	a0,1
    ...
    41e4:	9c050513          	addi	a0,a0,-1600 # 7ba0 <malloc+0x1bd2>
    41e8:	00002097          	auipc	ra,0x2
    41ec:	d2e080e7          	jalr	-722(ra) # 5f16 <printf>
    exit(1);
    41f0:	4505                	li	a0,1
    ...
    4200:	9cc50513          	addi	a0,a0,-1588 # 7bc8 <malloc+0x1bfa>
    4204:	00002097          	auipc	ra,0x2
    4208:	d12080e7          	jalr	-750(ra) # 5f16 <printf>
    exit(1);
    420c:	4505                	li	a0,1
...
0000000000004216 <iref>:
{
    ...
    4234:	9b0a0a13          	addi	s4,s4,-1616 # 7be0 <malloc+0x1c12>
    mkdir("");
    4238:	00003497          	auipc	s1,0x3
    423c:	4b048493          	addi	s1,s1,1200 # 76e8 <malloc+0x171a>
    link("README", "");
    4240:	00002a97          	auipc	s5,0x2
    4244:	090a8a93          	addi	s5,s5,144 # 62d0 <malloc+0x302>
    fd = open("xx", O_CREATE);
    4248:	00004997          	auipc	s3,0x4
    424c:	89098993          	addi	s3,s3,-1904 # 7ad8 <malloc+0x1b0a>
    4250:	a891                	j	42a4 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    4252:	85da                	mv	a1,s6
    4254:	00004517          	auipc	a0,0x4
    4258:	99450513          	addi	a0,a0,-1644 # 7be8 <malloc+0x1c1a>
    425c:	00002097          	auipc	ra,0x2
    4260:	cba080e7          	jalr	-838(ra) # 5f16 <printf>
      exit(1);
    4264:	4505                	li	a0,1
    ...
    4274:	99050513          	addi	a0,a0,-1648 # 7c00 <malloc+0x1c32>
    4278:	00002097          	auipc	ra,0x2
    427c:	c9e080e7          	jalr	-866(ra) # 5f16 <printf>
      exit(1);
    4280:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    4308:	10498993          	addi	s3,s3,260 # 7408 <malloc+0x143a>
    unlink("irefd");
    430c:	00004917          	auipc	s2,0x4
    4310:	8d490913          	addi	s2,s2,-1836 # 7be0 <malloc+0x1c12>
    chdir("..");
    4314:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4330:	08450513          	addi	a0,a0,132 # 73b0 <malloc+0x13e2>
...
0000000000004350 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4360:	8bc50513          	addi	a0,a0,-1860 # 7c18 <malloc+0x1c4a>
  ...
  if(pid == 0){
    ...
    4384:	89850513          	addi	a0,a0,-1896 # 7c18 <malloc+0x1c4a>
    ...
    439a:	8a250513          	addi	a0,a0,-1886 # 7c38 <malloc+0x1c6a>
    439e:	00002097          	auipc	ra,0x2
    43a2:	b78080e7          	jalr	-1160(ra) # 5f16 <printf>
      exit(1);
    43a6:	4505                	li	a0,1
    ...
    43b6:	86e50513          	addi	a0,a0,-1938 # 7c20 <malloc+0x1c52>
    43ba:	00002097          	auipc	ra,0x2
    43be:	b5c080e7          	jalr	-1188(ra) # 5f16 <printf>
    exit(1);
    43c2:	4505                	li	a0,1
    ...
    43d2:	5b250513          	addi	a0,a0,1458 # 6980 <malloc+0x9b2>
    43d6:	00002097          	auipc	ra,0x2
    43da:	b40080e7          	jalr	-1216(ra) # 5f16 <printf>
    exit(1);
    43de:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    4400:	81c50513          	addi	a0,a0,-2020 # 7c18 <malloc+0x1c4a>
    ...
    4414:	76050513          	addi	a0,a0,1888 # 6b70 <malloc+0xba2>
    4418:	00002097          	auipc	ra,0x2
    441c:	afe080e7          	jalr	-1282(ra) # 5f16 <printf>
    exit(1);
    4420:	4505                	li	a0,1
...
0000000000004442 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4452:	81250513          	addi	a0,a0,-2030 # 7c60 <malloc+0x1c92>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    447e:	7e650513          	addi	a0,a0,2022 # 7c60 <malloc+0x1c92>
  ...
  sleep(10); // one second
    ...
    44b6:	68e50513          	addi	a0,a0,1678 # 6b40 <malloc+0xb72>
    44ba:	00002097          	auipc	ra,0x2
    44be:	a5c080e7          	jalr	-1444(ra) # 5f16 <printf>
    exit(1);
    44c2:	4505                	li	a0,1
    ...
    44d0:	79448493          	addi	s1,s1,1940 # 7c60 <malloc+0x1c92>
    44d4:	4581                	li	a1,0
    44d6:	8526                	mv	a0,s1
    ...
    44f8:	76c50513          	addi	a0,a0,1900 # 7c60 <malloc+0x1c92>
...
0000000000004518 <killstatus>:
{
  ...
  exit(0);
    ...
    457e:	40650513          	addi	a0,a0,1030 # 6980 <malloc+0x9b2>
    4582:	00002097          	auipc	ra,0x2
    4586:	994080e7          	jalr	-1644(ra) # 5f16 <printf>
      exit(1);
    458a:	4505                	li	a0,1
    ...
    45a4:	6d050513          	addi	a0,a0,1744 # 7c70 <malloc+0x1ca2>
    45a8:	00002097          	auipc	ra,0x2
    45ac:	96e080e7          	jalr	-1682(ra) # 5f16 <printf>
       exit(1);
    45b0:	4505                	li	a0,1
...
00000000000045ba <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    45e4:	56050513          	addi	a0,a0,1376 # 6b40 <malloc+0xb72>
    45e8:	00002097          	auipc	ra,0x2
    45ec:	92e080e7          	jalr	-1746(ra) # 5f16 <printf>
    exit(1);
    45f0:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    4612:	37250513          	addi	a0,a0,882 # 6980 <malloc+0x9b2>
    4616:	00002097          	auipc	ra,0x2
    461a:	900080e7          	jalr	-1792(ra) # 5f16 <printf>
    exit(1);
    461e:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    4656:	b1658593          	addi	a1,a1,-1258 # 6168 <malloc+0x19a>
    ...
    4680:	30450513          	addi	a0,a0,772 # 6980 <malloc+0x9b2>
    4684:	00002097          	auipc	ra,0x2
    4688:	892080e7          	jalr	-1902(ra) # 5f16 <printf>
     exit(1);
    468c:	4505                	li	a0,1
    ...
    469c:	5f850513          	addi	a0,a0,1528 # 7c90 <malloc+0x1cc2>
    46a0:	00002097          	auipc	ra,0x2
    46a4:	876080e7          	jalr	-1930(ra) # 5f16 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46d8:	5d450513          	addi	a0,a0,1492 # 7ca8 <malloc+0x1cda>
    46dc:	00002097          	auipc	ra,0x2
    46e0:	83a080e7          	jalr	-1990(ra) # 5f16 <printf>
}
  ...
  printf("kill... ");
    ...
    4704:	5c050513          	addi	a0,a0,1472 # 7cc0 <malloc+0x1cf2>
    4708:	00002097          	auipc	ra,0x2
    470c:	80e080e7          	jalr	-2034(ra) # 5f16 <printf>
  kill(pid1);
    4710:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    4732:	5a250513          	addi	a0,a0,1442 # 7cd0 <malloc+0x1d02>
    4736:	00001097          	auipc	ra,0x1
    473a:	7e0080e7          	jalr	2016(ra) # 5f16 <printf>
  wait(0);
    473e:	4501                	li	a0,0
...
000000000000475e <reparent>:
{
  ...
  exit(0);
    ...
    47b2:	1d250513          	addi	a0,a0,466 # 6980 <malloc+0x9b2>
    47b6:	00001097          	auipc	ra,0x1
    47ba:	760080e7          	jalr	1888(ra) # 5f16 <printf>
      exit(1);
    47be:	4505                	li	a0,1
    ...
    47ce:	33e50513          	addi	a0,a0,830 # 6b08 <malloc+0xb3a>
    47d2:	00001097          	auipc	ra,0x1
    47d6:	744080e7          	jalr	1860(ra) # 5f16 <printf>
        exit(1);
    47da:	4505                	li	a0,1
...
000000000000480e <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4844:	24850513          	addi	a0,a0,584 # 6a88 <malloc+0xaba>
    4848:	00001097          	auipc	ra,0x1
    484c:	6ce080e7          	jalr	1742(ra) # 5f16 <printf>
    exit(1);
    4850:	4505                	li	a0,1
    ...
    4878:	8f458593          	addi	a1,a1,-1804 # 6168 <malloc+0x19a>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    493c:	3a850513          	addi	a0,a0,936 # 7ce0 <malloc+0x1d12>
    4940:	00001097          	auipc	ra,0x1
    4944:	5d6080e7          	jalr	1494(ra) # 5f16 <printf>
    exit(1);
    4948:	4505                	li	a0,1
    ...
    4958:	02c50513          	addi	a0,a0,44 # 6980 <malloc+0x9b2>
    495c:	00001097          	auipc	ra,0x1
    4960:	5ba080e7          	jalr	1466(ra) # 5f16 <printf>
    exit(1);
    4964:	4505                	li	a0,1
    ...
    49a4:	36050513          	addi	a0,a0,864 # 7d00 <malloc+0x1d32>
    49a8:	00001097          	auipc	ra,0x1
    49ac:	56e080e7          	jalr	1390(ra) # 5f16 <printf>
    exit(1);
    49b0:	4505                	li	a0,1
...
00000000000049c4 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a0e:	5c4080e7          	jalr	1476(ra) # 5fce <malloc>
    ...
    4a48:	2ec50513          	addi	a0,a0,748 # 7d30 <malloc+0x1d62>
    4a4c:	00001097          	auipc	ra,0x1
    4a50:	4ca080e7          	jalr	1226(ra) # 5f16 <printf>
      exit(1);
    4a54:	4505                	li	a0,1
...
0000000000004a68 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4afe:	26650513          	addi	a0,a0,614 # 7d60 <malloc+0x1d92>
    4b02:	00001097          	auipc	ra,0x1
    4b06:	414080e7          	jalr	1044(ra) # 5f16 <printf>
    exit(1);
    4b0a:	4505                	li	a0,1
    ...
    4b1a:	27250513          	addi	a0,a0,626 # 7d88 <malloc+0x1dba>
    4b1e:	00001097          	auipc	ra,0x1
    4b22:	3f8080e7          	jalr	1016(ra) # 5f16 <printf>
      exit(1);
    4b26:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    4b5e:	1f650513          	addi	a0,a0,502 # 7d50 <malloc+0x1d82>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4b9e:	20e50513          	addi	a0,a0,526 # 7da8 <malloc+0x1dda>
    4ba2:	00001097          	auipc	ra,0x1
    4ba6:	374080e7          	jalr	884(ra) # 5f16 <printf>
    exit(1);
    4baa:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    4bda:	17a50513          	addi	a0,a0,378 # 7d50 <malloc+0x1d82>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c00:	1d450513          	addi	a0,a0,468 # 7dd0 <malloc+0x1e02>
    4c04:	00001097          	auipc	ra,0x1
    4c08:	312080e7          	jalr	786(ra) # 5f16 <printf>
    exit(1);
    4c0c:	4505                	li	a0,1
...
0000000000004c20 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4c44:	1a878793          	addi	a5,a5,424 # 7de8 <malloc+0x1e1a>
    4c48:	f6f43823          	sd	a5,-144(s0)
    4c4c:	00003797          	auipc	a5,0x3
    4c50:	1a478793          	addi	a5,a5,420 # 7df0 <malloc+0x1e22>
    4c54:	f6f43c23          	sd	a5,-136(s0)
    4c58:	00003797          	auipc	a5,0x3
    4c5c:	1a078793          	addi	a5,a5,416 # 7df8 <malloc+0x1e2a>
    4c60:	f8f43023          	sd	a5,-128(s0)
    4c64:	00003797          	auipc	a5,0x3
    4c68:	19c78793          	addi	a5,a5,412 # 7e00 <malloc+0x1e32>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4cd6:	0b650513          	addi	a0,a0,182 # 6d88 <malloc+0xdba>
    4cda:	00001097          	auipc	ra,0x1
    4cde:	23c080e7          	jalr	572(ra) # 5f16 <printf>
      exit(1);
    4ce2:	4505                	li	a0,1
    ...
    4d50:	0bc50513          	addi	a0,a0,188 # 7e08 <malloc+0x1e3a>
    4d54:	00001097          	auipc	ra,0x1
    4d58:	1c2080e7          	jalr	450(ra) # 5f16 <printf>
        exit(1);
    4d5c:	4505                	li	a0,1
    ...
    4d6a:	0b250513          	addi	a0,a0,178 # 7e18 <malloc+0x1e4a>
    4d6e:	00001097          	auipc	ra,0x1
    4d72:	1a8080e7          	jalr	424(ra) # 5f16 <printf>
          exit(1);
    4d76:	4505                	li	a0,1
    ...
    4d90:	0a450513          	addi	a0,a0,164 # 7e30 <malloc+0x1e62>
    4d94:	00001097          	auipc	ra,0x1
    4d98:	182080e7          	jalr	386(ra) # 5f16 <printf>
          exit(1);
    4d9c:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e18:	02c50513          	addi	a0,a0,44 # 7e40 <malloc+0x1e72>
    4e1c:	00001097          	auipc	ra,0x1
    4e20:	0fa080e7          	jalr	250(ra) # 5f16 <printf>
      exit(1);
    4e24:	4505                	li	a0,1
...
0000000000004e4c <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4e7a:	fe2b8b93          	addi	s7,s7,-30 # 7e58 <malloc+0x1e8a>
  for(i = 0; i < N; i++){
    ...
    4ebc:	fa850513          	addi	a0,a0,-88 # 7e60 <malloc+0x1e92>
    4ec0:	00001097          	auipc	ra,0x1
    4ec4:	056080e7          	jalr	86(ra) # 5f16 <printf>
        exit(1);
    4ec8:	4505                	li	a0,1
    ...
    4eda:	f8250513          	addi	a0,a0,-126 # 7e58 <malloc+0x1e8a>
  ...
  fd = open(".", 0);
    ...
    4f12:	8d250513          	addi	a0,a0,-1838 # 67e0 <malloc+0x812>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f8a:	efa50513          	addi	a0,a0,-262 # 7e80 <malloc+0x1eb2>
    4f8e:	00001097          	auipc	ra,0x1
    4f92:	f88080e7          	jalr	-120(ra) # 5f16 <printf>
        exit(1);
    4f96:	4505                	li	a0,1
    ...
    4faa:	efa50513          	addi	a0,a0,-262 # 7ea0 <malloc+0x1ed2>
    4fae:	00001097          	auipc	ra,0x1
    4fb2:	f68080e7          	jalr	-152(ra) # 5f16 <printf>
        exit(1);
    4fb6:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4fe2:	eea50513          	addi	a0,a0,-278 # 7ec8 <malloc+0x1efa>
    4fe6:	00001097          	auipc	ra,0x1
    4fea:	f30080e7          	jalr	-208(ra) # 5f16 <printf>
    exit(1);
    4fee:	4505                	li	a0,1
    ...
    4ffe:	98650513          	addi	a0,a0,-1658 # 6980 <malloc+0x9b2>
    5002:	00001097          	auipc	ra,0x1
    5006:	f14080e7          	jalr	-236(ra) # 5f16 <printf>
      exit(1);
    500a:	4505                	li	a0,1
...
00000000000051a8 <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    5230:	cd450513          	addi	a0,a0,-812 # 7f00 <malloc+0x1f32>
  ...
  for(i = 0; ; i++){
    ...
    5294:	c8050513          	addi	a0,a0,-896 # 7f10 <malloc+0x1f42>
    5298:	00001097          	auipc	ra,0x1
    529c:	c7e080e7          	jalr	-898(ra) # 5f16 <printf>
    exit(1);
    52a0:	4505                	li	a0,1
    ...
    52b0:	c8450513          	addi	a0,a0,-892 # 7f30 <malloc+0x1f62>
    52b4:	00001097          	auipc	ra,0x1
    52b8:	c62080e7          	jalr	-926(ra) # 5f16 <printf>
      exit(1);
    52bc:	4505                	li	a0,1
    ...
    52cc:	c8850513          	addi	a0,a0,-888 # 7f50 <malloc+0x1f82>
    52d0:	00001097          	auipc	ra,0x1
    52d4:	c46080e7          	jalr	-954(ra) # 5f16 <printf>
    exit(1);
    52d8:	4505                	li	a0,1
    ...
    52e8:	c8c50513          	addi	a0,a0,-884 # 7f70 <malloc+0x1fa2>
    52ec:	00001097          	auipc	ra,0x1
    52f0:	c2a080e7          	jalr	-982(ra) # 5f16 <printf>
      exit(1);
    52f4:	4505                	li	a0,1
    ...
    5304:	c9050513          	addi	a0,a0,-880 # 7f90 <malloc+0x1fc2>
    5308:	00001097          	auipc	ra,0x1
    530c:	c0e080e7          	jalr	-1010(ra) # 5f16 <printf>
      exit(1);
    5310:	4505                	li	a0,1
    ...
    5320:	c8c50513          	addi	a0,a0,-884 # 7fa8 <malloc+0x1fda>
    5324:	00001097          	auipc	ra,0x1
    5328:	bf2080e7          	jalr	-1038(ra) # 5f16 <printf>
      exit(1);
    532c:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    534e:	bb650513          	addi	a0,a0,-1098 # 7f00 <malloc+0x1f32>
    ...
    5372:	c5a50513          	addi	a0,a0,-934 # 7fc8 <malloc+0x1ffa>
    5376:	00001097          	auipc	ra,0x1
    537a:	ba0080e7          	jalr	-1120(ra) # 5f16 <printf>
    exit(1);
    537e:	4505                	li	a0,1
...
0000000000005388 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    53a8:	c4450513          	addi	a0,a0,-956 # 7fe8 <malloc+0x201a>
    53ac:	00001097          	auipc	ra,0x1
    53b0:	b6a080e7          	jalr	-1174(ra) # 5f16 <printf>
  for(nfiles = 0; ; nfiles++){
    53b4:	4481                	li	s1,0
    name[0] = 'f';
    ...
    53c8:	c34c8c93          	addi	s9,s9,-972 # 7ff8 <malloc+0x202a>
    name[0] = 'f';
    ...
    5416:	b04080e7          	jalr	-1276(ra) # 5f16 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    5438:	bd450513          	addi	a0,a0,-1068 # 8008 <malloc+0x203a>
    543c:	00001097          	auipc	ra,0x1
    5440:	ada080e7          	jalr	-1318(ra) # 5f16 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    54ae:	b7e50513          	addi	a0,a0,-1154 # 8028 <malloc+0x205a>
    54b2:	00001097          	auipc	ra,0x1
    54b6:	a64080e7          	jalr	-1436(ra) # 5f16 <printf>
}
    ...
    5504:	b1850513          	addi	a0,a0,-1256 # 8018 <malloc+0x204a>
    5508:	00001097          	auipc	ra,0x1
    550c:	a0e080e7          	jalr	-1522(ra) # 5f16 <printf>
    close(fd);
    5510:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5536:	b0e50513          	addi	a0,a0,-1266 # 8040 <malloc+0x2072>
    553a:	00001097          	auipc	ra,0x1
    553e:	9dc080e7          	jalr	-1572(ra) # 5f16 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    5566:	b0650513          	addi	a0,a0,-1274 # 8068 <malloc+0x209a>
    556a:	00001097          	auipc	ra,0x1
    556e:	9ac080e7          	jalr	-1620(ra) # 5f16 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    558a:	aca50513          	addi	a0,a0,-1334 # 8050 <malloc+0x2082>
    558e:	00001097          	auipc	ra,0x1
    5592:	988080e7          	jalr	-1656(ra) # 5f16 <printf>
    exit(1);
    5596:	4505                	li	a0,1
    ...
    55b2:	ac250513          	addi	a0,a0,-1342 # 8070 <malloc+0x20a2>
    55b6:	00001097          	auipc	ra,0x1
    55ba:	960080e7          	jalr	-1696(ra) # 5f16 <printf>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    5602:	a7a50513          	addi	a0,a0,-1414 # 8078 <malloc+0x20aa>
    5606:	00001097          	auipc	ra,0x1
    560a:	910080e7          	jalr	-1776(ra) # 5f16 <printf>
        return 1;
    560e:	4505                	li	a0,1
}
...
countfree()
{
  ...
  if(pid == 0){
    ...
    565c:	b1098993          	addi	s3,s3,-1264 # 6168 <malloc+0x19a>
      uint64 a = (uint64) sbrk(4096);
    ...
    568e:	a4650513          	addi	a0,a0,-1466 # 80d0 <malloc+0x2102>
    5692:	00001097          	auipc	ra,0x1
    5696:	884080e7          	jalr	-1916(ra) # 5f16 <printf>
        exit(1);
    569a:	4505                	li	a0,1
    ...
    56a8:	9ec50513          	addi	a0,a0,-1556 # 8090 <malloc+0x20c2>
    56ac:	00001097          	auipc	ra,0x1
    56b0:	86a080e7          	jalr	-1942(ra) # 5f16 <printf>
    exit(1);
    56b4:	4505                	li	a0,1
    ...
    56c2:	9f250513          	addi	a0,a0,-1550 # 80b0 <malloc+0x20e2>
    56c6:	00001097          	auipc	ra,0x1
    56ca:	850080e7          	jalr	-1968(ra) # 5f16 <printf>
    exit(1);
    56ce:	4505                	li	a0,1
  ...
  while(1){
    ...
    5710:	9e450513          	addi	a0,a0,-1564 # 80f0 <malloc+0x2122>
    5714:	00001097          	auipc	ra,0x1
    5718:	802080e7          	jalr	-2046(ra) # 5f16 <printf>
      exit(1);
    571c:	4505                	li	a0,1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    5772:	9a2b8b93          	addi	s7,s7,-1630 # 8110 <malloc+0x2142>
    int free0 = countfree();
    int free1 = 0;
    ...
    578c:	9a0d0d13          	addi	s10,s10,-1632 # 8128 <malloc+0x215a>
          return 1;
        }
      }
    }
    ...
    5794:	9b8c8c93          	addi	s9,s9,-1608 # 8148 <malloc+0x217a>
    5798:	a839                	j	57b6 <drivetests+0x6a>
        printf("usertests slow tests starting\n");
    579a:	856a                	mv	a0,s10
    579c:	00000097          	auipc	ra,0x0
    57a0:	77a080e7          	jalr	1914(ra) # 5f16 <printf>
    ...
    57bc:	75e080e7          	jalr	1886(ra) # 5f16 <printf>
    int free0 = countfree();
    ...
    5804:	716080e7          	jalr	1814(ra) # 5f16 <printf>
      if(continuous != 2) {
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    586c:	91058593          	addi	a1,a1,-1776 # 8178 <malloc+0x21aa>
  ...
  char *justone = 0;
    ...
    588a:	8fa58593          	addi	a1,a1,-1798 # 8180 <malloc+0x21b2>
    ...
    58a0:	93458593          	addi	a1,a1,-1740 # 81d0 <malloc+0x2202>
  ...
  int continuous = 0;
    ...
    58cc:	8c050513          	addi	a0,a0,-1856 # 8188 <malloc+0x21ba>
    58d0:	00000097          	auipc	ra,0x0
    58d4:	646080e7          	jalr	1606(ra) # 5f16 <printf>
    exit(1);
    58d8:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    58f2:	8ca50513          	addi	a0,a0,-1846 # 81b8 <malloc+0x21ea>
    58f6:	00000097          	auipc	ra,0x0
    58fa:	620080e7          	jalr	1568(ra) # 5f16 <printf>
  exit(0);
    58fe:	4501                	li	a0,0
...
putc(int fd, char c)
{
    5c4e:	1101                	addi	sp,sp,-32
    5c50:	ec06                	sd	ra,24(sp)
    5c52:	e822                	sd	s0,16(sp)
    5c54:	1000                	addi	s0,sp,32
    5c56:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    5c5a:	4605                	li	a2,1
    5c5c:	fef40593          	addi	a1,s0,-17
    5c60:	00000097          	auipc	ra,0x0
    5c64:	f4e080e7          	jalr	-178(ra) # 5bae <write>
}
    5c68:	60e2                	ld	ra,24(sp)
    5c6a:	6442                	ld	s0,16(sp)
    5c6c:	6105                	addi	sp,sp,32
    5c6e:	8082                	ret

0000000000005c70 <printint>:
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
  if (sgn && xx < 0)
    5c80:	c299                	beqz	a3,5c86 <printint+0x16>
    5c82:	0805c963          	bltz	a1,5d14 <printint+0xa4>
    neg = 1;
    x = -xx;
  }
  else
  {
    x = xx;
    5c86:	2581                	sext.w	a1,a1
  neg = 0;
    5c88:	4881                	li	a7,0
    5c8a:	fc040693          	addi	a3,s0,-64
  }
  ...
  {
    buf[i++] = digits[x % base];
    5c90:	2601                	sext.w	a2,a2
    5c92:	00003517          	auipc	a0,0x3
    5c96:	90650513          	addi	a0,a0,-1786 # 8598 <digits>
    5c9a:	883a                	mv	a6,a4
    5c9c:	2705                	addiw	a4,a4,1
    5c9e:	02c5f7bb          	remuw	a5,a1,a2
    5ca2:	1782                	slli	a5,a5,0x20
    5ca4:	9381                	srli	a5,a5,0x20
    5ca6:	97aa                	add	a5,a5,a0
    5ca8:	0007c783          	lbu	a5,0(a5)
    5cac:	00f68023          	sb	a5,0(a3)
  } while ((x /= base) != 0);
    5cb0:	0005879b          	sext.w	a5,a1
    5cb4:	02c5d5bb          	divuw	a1,a1,a2
    5cb8:	0685                	addi	a3,a3,1
    5cba:	fec7f0e3          	bgeu	a5,a2,5c9a <printint+0x2a>
  if (neg)
    5cbe:	00088c63          	beqz	a7,5cd6 <printint+0x66>
    buf[i++] = '-';
    5cc2:	fd070793          	addi	a5,a4,-48
    5cc6:	00878733          	add	a4,a5,s0
    5cca:	02d00793          	li	a5,45
    5cce:	fef70823          	sb	a5,-16(a4)
    5cd2:	0028071b          	addiw	a4,a6,2

  while (--i >= 0)
    5cd6:	02e05863          	blez	a4,5d06 <printint+0x96>
    5cda:	fc040793          	addi	a5,s0,-64
    5cde:	00e78933          	add	s2,a5,a4
    5ce2:	fff78993          	addi	s3,a5,-1
    5ce6:	99ba                	add	s3,s3,a4
    5ce8:	377d                	addiw	a4,a4,-1
    5cea:	1702                	slli	a4,a4,0x20
    5cec:	9301                	srli	a4,a4,0x20
    5cee:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    5cf2:	fff94583          	lbu	a1,-1(s2)
    5cf6:	8526                	mv	a0,s1
    5cf8:	00000097          	auipc	ra,0x0
    5cfc:	f56080e7          	jalr	-170(ra) # 5c4e <putc>
  while (--i >= 0)
    5d00:	197d                	addi	s2,s2,-1
    5d02:	ff3918e3          	bne	s2,s3,5cf2 <printint+0x82>
}
    5d06:	70e2                	ld	ra,56(sp)
    5d08:	7442                	ld	s0,48(sp)
    5d0a:	74a2                	ld	s1,40(sp)
    5d0c:	7902                	ld	s2,32(sp)
    5d0e:	69e2                	ld	s3,24(sp)
    5d10:	6121                	addi	sp,sp,64
    5d12:	8082                	ret
    x = -xx;
    5d14:	40b005bb          	negw	a1,a1
    neg = 1;
    5d18:	4885                	li	a7,1
    x = -xx;
    5d1a:	bf85                	j	5c8a <printint+0x1a>

0000000000005d1c <vprintf>:
...
{
    5d1c:	715d                	addi	sp,sp,-80
    5d1e:	e486                	sd	ra,72(sp)
    5d20:	e0a2                	sd	s0,64(sp)
    5d22:	fc26                	sd	s1,56(sp)
    5d24:	f84a                	sd	s2,48(sp)
    5d26:	f44e                	sd	s3,40(sp)
    5d28:	f052                	sd	s4,32(sp)
    5d2a:	ec56                	sd	s5,24(sp)
    5d2c:	e85a                	sd	s6,16(sp)
    5d2e:	e45e                	sd	s7,8(sp)
    5d30:	e062                	sd	s8,0(sp)
  ...
  state = 0;
  for (i = 0; fmt[i]; i++)
    5d34:	0005c903          	lbu	s2,0(a1)
    5d38:	18090c63          	beqz	s2,5ed0 <vprintf+0x1b4>
    5d3c:	8aaa                	mv	s5,a0
    5d3e:	8bb2                	mv	s7,a2
    5d40:	00158493          	addi	s1,a1,1
  state = 0;
    5d44:	4981                	li	s3,0
      else
      {
    ...
    5d46:	02500a13          	li	s4,37
    5d4a:	4b55                	li	s6,21
    5d4c:	a839                	j	5d6a <vprintf+0x4e>
        putc(fd, c);
    5d4e:	85ca                	mv	a1,s2
    5d50:	8556                	mv	a0,s5
    5d52:	00000097          	auipc	ra,0x0
    5d56:	efc080e7          	jalr	-260(ra) # 5c4e <putc>
    5d5a:	a019                	j	5d60 <vprintf+0x44>
    else if (state == '%')
    5d5c:	01498d63          	beq	s3,s4,5d76 <vprintf+0x5a>
  for (i = 0; fmt[i]; i++)
    5d60:	0485                	addi	s1,s1,1
    5d62:	fff4c903          	lbu	s2,-1(s1)
    5d66:	16090563          	beqz	s2,5ed0 <vprintf+0x1b4>
    if (state == 0)
    5d6a:	fe0999e3          	bnez	s3,5d5c <vprintf+0x40>
      if (c == '%')
    5d6e:	ff4910e3          	bne	s2,s4,5d4e <vprintf+0x32>
        state = '%';
    5d72:	89d2                	mv	s3,s4
    5d74:	b7f5                	j	5d60 <vprintf+0x44>
    {
      if (c == 'd')
    5d76:	13490263          	beq	s2,s4,5e9a <vprintf+0x17e>
    5d7a:	f9d9079b          	addiw	a5,s2,-99
    5d7e:	0ff7f793          	zext.b	a5,a5
    5d82:	12fb6563          	bltu	s6,a5,5eac <vprintf+0x190>
    5d86:	f9d9079b          	addiw	a5,s2,-99
    5d8a:	0ff7f713          	zext.b	a4,a5
    5d8e:	10eb6f63          	bltu	s6,a4,5eac <vprintf+0x190>
    5d92:	00271793          	slli	a5,a4,0x2
    5d96:	00002717          	auipc	a4,0x2
    5d9a:	7aa70713          	addi	a4,a4,1962 # 8540 <malloc+0x2572>
    5d9e:	97ba                	add	a5,a5,a4
    5da0:	439c                	lw	a5,0(a5)
    ...
    5db8:	ebc080e7          	jalr	-324(ra) # 5c70 <printint>
    5dbc:	8bca                	mv	s7,s2
      {
    ...
    5dd4:	ea0080e7          	jalr	-352(ra) # 5c70 <printint>
    5dd8:	8bca                	mv	s7,s2
      state = 0;
    5dda:	4981                	li	s3,0
    5ddc:	b751                	j	5d60 <vprintf+0x44>
    ...
    5df0:	e84080e7          	jalr	-380(ra) # 5c70 <printint>
    5df4:	8bca                	mv	s7,s2
      state = 0;
    5df6:	4981                	li	s3,0
    5df8:	b7a5                	j	5d60 <vprintf+0x44>
        printptr(fd, va_arg(ap, uint64));
    5dfa:	008b8c13          	addi	s8,s7,8
    5dfe:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    5e02:	03000593          	li	a1,48
    5e06:	8556                	mv	a0,s5
    5e08:	00000097          	auipc	ra,0x0
    5e0c:	e46080e7          	jalr	-442(ra) # 5c4e <putc>
  putc(fd, 'x');
    5e10:	07800593          	li	a1,120
    5e14:	8556                	mv	a0,s5
    5e16:	00000097          	auipc	ra,0x0
    5e1a:	e38080e7          	jalr	-456(ra) # 5c4e <putc>
    5e1e:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5e20:	00002b97          	auipc	s7,0x2
    5e24:	778b8b93          	addi	s7,s7,1912 # 8598 <digits>
    5e28:	03c9d793          	srli	a5,s3,0x3c
    5e2c:	97de                	add	a5,a5,s7
    5e2e:	0007c583          	lbu	a1,0(a5)
    5e32:	8556                	mv	a0,s5
    5e34:	00000097          	auipc	ra,0x0
    5e38:	e1a080e7          	jalr	-486(ra) # 5c4e <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5e3c:	0992                	slli	s3,s3,0x4
    5e3e:	397d                	addiw	s2,s2,-1
    5e40:	fe0914e3          	bnez	s2,5e28 <vprintf+0x10c>
        printptr(fd, va_arg(ap, uint64));
    5e44:	8be2                	mv	s7,s8
      state = 0;
    5e46:	4981                	li	s3,0
    5e48:	bf21                	j	5d60 <vprintf+0x44>
        s = va_arg(ap, char *);
    5e4a:	008b8993          	addi	s3,s7,8
    5e4e:	000bb903          	ld	s2,0(s7)
        if (s == 0)
    5e52:	02090163          	beqz	s2,5e74 <vprintf+0x158>
        while (*s != 0)
    5e56:	00094583          	lbu	a1,0(s2)
    5e5a:	c9a5                	beqz	a1,5eca <vprintf+0x1ae>
          putc(fd, *s);
    5e5c:	8556                	mv	a0,s5
    5e5e:	00000097          	auipc	ra,0x0
    5e62:	df0080e7          	jalr	-528(ra) # 5c4e <putc>
          s++;
    5e66:	0905                	addi	s2,s2,1
        while (*s != 0)
    5e68:	00094583          	lbu	a1,0(s2)
    5e6c:	f9e5                	bnez	a1,5e5c <vprintf+0x140>
        s = va_arg(ap, char *);
    5e6e:	8bce                	mv	s7,s3
      state = 0;
    5e70:	4981                	li	s3,0
    5e72:	b5fd                	j	5d60 <vprintf+0x44>
          s = "(null)";
    5e74:	00002917          	auipc	s2,0x2
    5e78:	6c490913          	addi	s2,s2,1732 # 8538 <malloc+0x256a>
        while (*s != 0)
    5e7c:	02800593          	li	a1,40
    5e80:	bff1                	j	5e5c <vprintf+0x140>
        putc(fd, va_arg(ap, uint));
    5e82:	008b8913          	addi	s2,s7,8
    5e86:	000bc583          	lbu	a1,0(s7)
    5e8a:	8556                	mv	a0,s5
    5e8c:	00000097          	auipc	ra,0x0
    5e90:	dc2080e7          	jalr	-574(ra) # 5c4e <putc>
    5e94:	8bca                	mv	s7,s2
      state = 0;
    5e96:	4981                	li	s3,0
    5e98:	b5e1                	j	5d60 <vprintf+0x44>
        putc(fd, c);
    5e9a:	02500593          	li	a1,37
    5e9e:	8556                	mv	a0,s5
    5ea0:	00000097          	auipc	ra,0x0
    5ea4:	dae080e7          	jalr	-594(ra) # 5c4e <putc>
      state = 0;
    5ea8:	4981                	li	s3,0
    5eaa:	bd5d                	j	5d60 <vprintf+0x44>
        putc(fd, '%');
    5eac:	02500593          	li	a1,37
    5eb0:	8556                	mv	a0,s5
    5eb2:	00000097          	auipc	ra,0x0
    5eb6:	d9c080e7          	jalr	-612(ra) # 5c4e <putc>
        putc(fd, c);
    5eba:	85ca                	mv	a1,s2
    5ebc:	8556                	mv	a0,s5
    5ebe:	00000097          	auipc	ra,0x0
    5ec2:	d90080e7          	jalr	-624(ra) # 5c4e <putc>
      state = 0;
    5ec6:	4981                	li	s3,0
    5ec8:	bd61                	j	5d60 <vprintf+0x44>
        s = va_arg(ap, char *);
    5eca:	8bce                	mv	s7,s3
      state = 0;
    5ecc:	4981                	li	s3,0
    5ece:	bd49                	j	5d60 <vprintf+0x44>
    }
  }
}
    5ed0:	60a6                	ld	ra,72(sp)
    5ed2:	6406                	ld	s0,64(sp)
    5ed4:	74e2                	ld	s1,56(sp)
    5ed6:	7942                	ld	s2,48(sp)
    5ed8:	79a2                	ld	s3,40(sp)
    5eda:	7a02                	ld	s4,32(sp)
    5edc:	6ae2                	ld	s5,24(sp)
    5ede:	6b42                	ld	s6,16(sp)
    5ee0:	6ba2                	ld	s7,8(sp)
    5ee2:	6c02                	ld	s8,0(sp)
    5ee4:	6161                	addi	sp,sp,80
    5ee6:	8082                	ret

0000000000005ee8 <fprintf>:

void fprintf(int fd, const char *fmt, ...)
{
    5ee8:	715d                	addi	sp,sp,-80
    5eea:	ec06                	sd	ra,24(sp)
    5eec:	e822                	sd	s0,16(sp)
    5eee:	1000                	addi	s0,sp,32
    5ef0:	e010                	sd	a2,0(s0)
    5ef2:	e414                	sd	a3,8(s0)
    5ef4:	e818                	sd	a4,16(s0)
    5ef6:	ec1c                	sd	a5,24(s0)
    5ef8:	03043023          	sd	a6,32(s0)
    5efc:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5f00:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5f04:	8622                	mv	a2,s0
    5f06:	00000097          	auipc	ra,0x0
    5f0a:	e16080e7          	jalr	-490(ra) # 5d1c <vprintf>
}
    5f0e:	60e2                	ld	ra,24(sp)
    5f10:	6442                	ld	s0,16(sp)
    5f12:	6161                	addi	sp,sp,80
    5f14:	8082                	ret

0000000000005f16 <printf>:

void printf(const char *fmt, ...)
{
    5f16:	711d                	addi	sp,sp,-96
    5f18:	ec06                	sd	ra,24(sp)
    5f1a:	e822                	sd	s0,16(sp)
    5f1c:	1000                	addi	s0,sp,32
    5f1e:	e40c                	sd	a1,8(s0)
    5f20:	e810                	sd	a2,16(s0)
    5f22:	ec14                	sd	a3,24(s0)
    5f24:	f018                	sd	a4,32(s0)
    5f26:	f41c                	sd	a5,40(s0)
    5f28:	03043823          	sd	a6,48(s0)
    5f2c:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5f30:	00840613          	addi	a2,s0,8
    5f34:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5f38:	85aa                	mv	a1,a0
    5f3a:	4505                	li	a0,1
    5f3c:	00000097          	auipc	ra,0x0
    5f40:	de0080e7          	jalr	-544(ra) # 5d1c <vprintf>
}
    5f44:	60e2                	ld	ra,24(sp)
    5f46:	6442                	ld	s0,16(sp)
    5f48:	6125                	addi	sp,sp,96
    5f4a:	8082                	ret

0000000000005f4c <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    5f4c:	1141                	addi	sp,sp,-16
    5f4e:	e422                	sd	s0,8(sp)
    5f50:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5f52:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5f56:	00003797          	auipc	a5,0x3
    5f5a:	4fa7b783          	ld	a5,1274(a5) # 9450 <freep>
    5f5e:	a02d                	j	5f88 <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5f60:	4618                	lw	a4,8(a2)
    5f62:	9f2d                	addw	a4,a4,a1
    5f64:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5f68:	6398                	ld	a4,0(a5)
    5f6a:	6310                	ld	a2,0(a4)
    5f6c:	a83d                	j	5faa <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5f6e:	ff852703          	lw	a4,-8(a0)
    5f72:	9f31                	addw	a4,a4,a2
    5f74:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5f76:	ff053683          	ld	a3,-16(a0)
    5f7a:	a091                	j	5fbe <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5f7c:	6398                	ld	a4,0(a5)
    5f7e:	00e7e463          	bltu	a5,a4,5f86 <free+0x3a>
    5f82:	00e6ea63          	bltu	a3,a4,5f96 <free+0x4a>
{
    5f86:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5f88:	fed7fae3          	bgeu	a5,a3,5f7c <free+0x30>
    5f8c:	6398                	ld	a4,0(a5)
    5f8e:	00e6e463          	bltu	a3,a4,5f96 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5f92:	fee7eae3          	bltu	a5,a4,5f86 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    5f96:	ff852583          	lw	a1,-8(a0)
    5f9a:	6390                	ld	a2,0(a5)
    5f9c:	02059813          	slli	a6,a1,0x20
    5fa0:	01c85713          	srli	a4,a6,0x1c
    5fa4:	9736                	add	a4,a4,a3
    5fa6:	fae60de3          	beq	a2,a4,5f60 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    5faa:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5fae:	4790                	lw	a2,8(a5)
    5fb0:	02061593          	slli	a1,a2,0x20
    5fb4:	01c5d713          	srli	a4,a1,0x1c
    5fb8:	973e                	add	a4,a4,a5
    5fba:	fae68ae3          	beq	a3,a4,5f6e <free+0x22>
    p->s.ptr = bp->s.ptr;
    5fbe:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    5fc0:	00003717          	auipc	a4,0x3
    5fc4:	48f73823          	sd	a5,1168(a4) # 9450 <freep>
}
    5fc8:	6422                	ld	s0,8(sp)
    5fca:	0141                	addi	sp,sp,16
    5fcc:	8082                	ret

0000000000005fce <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    5fce:	7139                	addi	sp,sp,-64
    5fd0:	fc06                	sd	ra,56(sp)
    5fd2:	f822                	sd	s0,48(sp)
    5fd4:	f426                	sd	s1,40(sp)
    5fd6:	f04a                	sd	s2,32(sp)
    5fd8:	ec4e                	sd	s3,24(sp)
    5fda:	e852                	sd	s4,16(sp)
    5fdc:	e456                	sd	s5,8(sp)
    5fde:	e05a                	sd	s6,0(sp)
  ...
  if((prevp = freep) == 0){
    ...
    5ff6:	45e53503          	ld	a0,1118(a0) # 9450 <freep>
    5ffa:	c515                	beqz	a0,6026 <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    6000:	02977f63          	bgeu	a4,s1,603e <malloc+0x70>
  if(nu < 4096)
    6004:	8a4e                	mv	s4,s3
    6006:	0009871b          	sext.w	a4,s3
    600a:	6685                	lui	a3,0x1
    600c:	00d77363          	bgeu	a4,a3,6012 <malloc+0x44>
    6010:	6a05                	lui	s4,0x1
    6012:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    6016:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    601a:	00003917          	auipc	s2,0x3
    601e:	43690913          	addi	s2,s2,1078 # 9450 <freep>
  if(p == (char*)-1)
    6022:	5afd                	li	s5,-1
    6024:	a895                	j	6098 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    6026:	0000a797          	auipc	a5,0xa
    602a:	c5278793          	addi	a5,a5,-942 # fc78 <base>
    602e:	00003717          	auipc	a4,0x3
    6032:	42f73123          	sd	a5,1058(a4) # 9450 <freep>
    6036:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    6038:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    603c:	b7e1                	j	6004 <malloc+0x36>
      if(p->s.size == nunits)
    603e:	02e48c63          	beq	s1,a4,6076 <malloc+0xa8>
        p->s.size -= nunits;
    6042:	4137073b          	subw	a4,a4,s3
    6046:	c798                	sw	a4,8(a5)
        p += p->s.size;
    6048:	02071693          	slli	a3,a4,0x20
    604c:	01c6d713          	srli	a4,a3,0x1c
    ...
    607a:	bff1                	j	6056 <malloc+0x88>
  hp->s.size = nu;
    607c:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    6080:	0541                	addi	a0,a0,16
    6082:	00000097          	auipc	ra,0x0
    6086:	eca080e7          	jalr	-310(ra) # 5f4c <free>
  return freep;
    608a:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    608e:	d971                	beqz	a0,6062 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    6090:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    6092:	4798                	lw	a4,8(a5)
    6094:	fa9775e3          	bgeu	a4,s1,603e <malloc+0x70>
    if(p == freep)
    6098:	00093703          	ld	a4,0(s2)
    609c:	853e                	mv	a0,a5
    609e:	fef719e3          	bne	a4,a5,6090 <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
    60a2:	8552                	mv	a0,s4
    60a4:	00000097          	auipc	ra,0x0
    60a8:	b72080e7          	jalr	-1166(ra) # 5c16 <sbrk>
  if(p == (char*)-1)
    60ac:	fd5518e3          	bne	a0,s5,607c <malloc+0xae>
        return 0;
    60b0:	4501                	li	a0,0
    60b2:	bf45                	j	6062 <malloc+0x94>
