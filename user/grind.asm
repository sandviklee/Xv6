...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      9e:	2c650513          	addi	a0,a0,710 # 1360 <malloc+0xf2>
      a2:	00001097          	auipc	ra,0x1
      a6:	df4080e7          	jalr	-524(ra) # e96 <mkdir>
  if(chdir("grindir") != 0){
      aa:	00001517          	auipc	a0,0x1
      ae:	2b650513          	addi	a0,a0,694 # 1360 <malloc+0xf2>
      b2:	00001097          	auipc	ra,0x1
      b6:	dec080e7          	jalr	-532(ra) # e9e <chdir>
      ba:	cd11                	beqz	a0,d6 <go+0x5e>
    printf("grind: chdir grindir failed\n");
      bc:	00001517          	auipc	a0,0x1
      c0:	2ac50513          	addi	a0,a0,684 # 1368 <malloc+0xfa>
      c4:	00001097          	auipc	ra,0x1
      c8:	0f2080e7          	jalr	242(ra) # 11b6 <printf>
    exit(1);
      cc:	4505                	li	a0,1
  ...
  chdir("/");
      ...
      da:	2b250513          	addi	a0,a0,690 # 1388 <malloc+0x11a>
      de:	00001097          	auipc	ra,0x1
      e2:	dc0080e7          	jalr	-576(ra) # e9e <chdir>
      e6:	00001997          	auipc	s3,0x1
      ea:	2b298993          	addi	s3,s3,690 # 1398 <malloc+0x12a>
      ee:	c489                	beqz	s1,f8 <go+0x80>
      f0:	00001997          	auipc	s3,0x1
      f4:	2a098993          	addi	s3,s3,672 # 1390 <malloc+0x122>
  uint64 iters = 0;
      f8:	4481                	li	s1,0
  int fd = -1;
      fa:	5a7d                	li	s4,-1
      fc:	00001917          	auipc	s2,0x1
     100:	54c90913          	addi	s2,s2,1356 # 1648 <malloc+0x3da>
    ...
    if(what == 1){
     ...
     10e:	29650513          	addi	a0,a0,662 # 13a0 <malloc+0x132>
    ...
    if(what == 1){
     ...
     168:	24c50513          	addi	a0,a0,588 # 13b0 <malloc+0x142>
     ...
     182:	22250513          	addi	a0,a0,546 # 13a0 <malloc+0x132>
     ...
     194:	1d050513          	addi	a0,a0,464 # 1360 <malloc+0xf2>
     ...
     1a6:	22650513          	addi	a0,a0,550 # 13c8 <malloc+0x15a>
     1aa:	00001097          	auipc	ra,0x1
     1ae:	cd4080e7          	jalr	-812(ra) # e7e <unlink>
      chdir("/");
     1b2:	00001517          	auipc	a0,0x1
     1b6:	1d650513          	addi	a0,a0,470 # 1388 <malloc+0x11a>
     1ba:	00001097          	auipc	ra,0x1
     1be:	ce4080e7          	jalr	-796(ra) # e9e <chdir>
     1c2:	b785                	j	122 <go+0xaa>
        printf("grind: chdir grindir failed\n");
     1c4:	00001517          	auipc	a0,0x1
     1c8:	1a450513          	addi	a0,a0,420 # 1368 <malloc+0xfa>
     1cc:	00001097          	auipc	ra,0x1
     1d0:	fea080e7          	jalr	-22(ra) # 11b6 <printf>
        exit(1);
     1d4:	4505                	li	a0,1
     ...
     1f0:	1e450513          	addi	a0,a0,484 # 13d0 <malloc+0x162>
     ...
     212:	1d250513          	addi	a0,a0,466 # 13e0 <malloc+0x172>
     ...
     256:	14e50513          	addi	a0,a0,334 # 13a0 <malloc+0x132>
     25a:	00001097          	auipc	ra,0x1
     25e:	c3c080e7          	jalr	-964(ra) # e96 <mkdir>
      close(open("a/../a/./a", O_CREATE|O_RDWR));
     262:	20200593          	li	a1,514
     266:	00001517          	auipc	a0,0x1
     26a:	19250513          	addi	a0,a0,402 # 13f8 <malloc+0x18a>
     ...
     282:	18a50513          	addi	a0,a0,394 # 1408 <malloc+0x19a>
     ...
     294:	18050513          	addi	a0,a0,384 # 1410 <malloc+0x1a2>
     298:	00001097          	auipc	ra,0x1
     29c:	bfe080e7          	jalr	-1026(ra) # e96 <mkdir>
      close(open("grindir/../b/b", O_CREATE|O_RDWR));
     2a0:	20200593          	li	a1,514
     2a4:	00001517          	auipc	a0,0x1
     2a8:	17450513          	addi	a0,a0,372 # 1418 <malloc+0x1aa>
     ...
     2c0:	16c50513          	addi	a0,a0,364 # 1428 <malloc+0x1ba>
     ...
     2d2:	12250513          	addi	a0,a0,290 # 13f0 <malloc+0x182>
     2d6:	00001097          	auipc	ra,0x1
     2da:	ba8080e7          	jalr	-1112(ra) # e7e <unlink>
      link("../grindir/./../a", "../b");
     2de:	00001597          	auipc	a1,0x1
     2e2:	0ea58593          	addi	a1,a1,234 # 13c8 <malloc+0x15a>
     2e6:	00001517          	auipc	a0,0x1
     2ea:	14a50513          	addi	a0,a0,330 # 1430 <malloc+0x1c2>
     ...
     2fc:	15050513          	addi	a0,a0,336 # 1448 <malloc+0x1da>
     300:	00001097          	auipc	ra,0x1
     304:	b7e080e7          	jalr	-1154(ra) # e7e <unlink>
      link(".././b", "/grindir/../a");
     308:	00001597          	auipc	a1,0x1
     30c:	0c858593          	addi	a1,a1,200 # 13d0 <malloc+0x162>
     310:	00001517          	auipc	a0,0x1
     314:	14850513          	addi	a0,a0,328 # 1458 <malloc+0x1ea>
     ...
     348:	11c50513          	addi	a0,a0,284 # 1460 <malloc+0x1f2>
     34c:	00001097          	auipc	ra,0x1
     350:	e6a080e7          	jalr	-406(ra) # 11b6 <printf>
        exit(1);
     354:	4505                	li	a0,1
     ...
     396:	0ce50513          	addi	a0,a0,206 # 1460 <malloc+0x1f2>
     39a:	00001097          	auipc	ra,0x1
     39e:	e1c080e7          	jalr	-484(ra) # 11b6 <printf>
        exit(1);
     3a2:	4505                	li	a0,1
     ...
     3f6:	08650513          	addi	a0,a0,134 # 1478 <malloc+0x20a>
     ...
     422:	02250513          	addi	a0,a0,34 # 1440 <malloc+0x1d2>
     ...
     444:	02050513          	addi	a0,a0,32 # 1460 <malloc+0x1f2>
     448:	00001097          	auipc	ra,0x1
     44c:	d6e080e7          	jalr	-658(ra) # 11b6 <printf>
        exit(1);
     450:	4505                	li	a0,1
     ...
     45e:	02e50513          	addi	a0,a0,46 # 1488 <malloc+0x21a>
     462:	00001097          	auipc	ra,0x1
     466:	d54080e7          	jalr	-684(ra) # 11b6 <printf>
        exit(1);
     46a:	4505                	li	a0,1
     ...
     4ac:	fb850513          	addi	a0,a0,-72 # 1460 <malloc+0x1f2>
     4b0:	00001097          	auipc	ra,0x1
     4b4:	d06080e7          	jalr	-762(ra) # 11b6 <printf>
        exit(1);
     4b8:	4505                	li	a0,1
     ...
     508:	f9c50513          	addi	a0,a0,-100 # 14a0 <malloc+0x232>
     50c:	00001097          	auipc	ra,0x1
     510:	caa080e7          	jalr	-854(ra) # 11b6 <printf>
        exit(1);
     514:	4505                	li	a0,1
     ...
     534:	f8858593          	addi	a1,a1,-120 # 14b8 <malloc+0x24a>
     ...
     570:	f5450513          	addi	a0,a0,-172 # 14c0 <malloc+0x252>
     574:	00001097          	auipc	ra,0x1
     578:	c42080e7          	jalr	-958(ra) # 11b6 <printf>
     57c:	b7f9                	j	54a <go+0x4d2>
          printf("grind: pipe read failed\n");
     57e:	00001517          	auipc	a0,0x1
     582:	f6250513          	addi	a0,a0,-158 # 14e0 <malloc+0x272>
     586:	00001097          	auipc	ra,0x1
     58a:	c30080e7          	jalr	-976(ra) # 11b6 <printf>
     58e:	bfd1                	j	562 <go+0x4ea>
        printf("grind: fork failed\n");
     590:	00001517          	auipc	a0,0x1
     594:	ed050513          	addi	a0,a0,-304 # 1460 <malloc+0x1f2>
     598:	00001097          	auipc	ra,0x1
     59c:	c1e080e7          	jalr	-994(ra) # 11b6 <printf>
        exit(1);
     5a0:	4505                	li	a0,1
     ...
     636:	e2e50513          	addi	a0,a0,-466 # 1460 <malloc+0x1f2>
     63a:	00001097          	auipc	ra,0x1
     63e:	b7c080e7          	jalr	-1156(ra) # 11b6 <printf>
        exit(1);
     642:	4505                	li	a0,1
     ...
     650:	eb450513          	addi	a0,a0,-332 # 1500 <malloc+0x292>
     ...
     664:	ea050513          	addi	a0,a0,-352 # 1500 <malloc+0x292>
     ...
     67c:	e4058593          	addi	a1,a1,-448 # 14b8 <malloc+0x24a>
     ...
     6c2:	e4250513          	addi	a0,a0,-446 # 1500 <malloc+0x292>
     6c6:	00000097          	auipc	ra,0x0
     6ca:	7b8080e7          	jalr	1976(ra) # e7e <unlink>
     6ce:	bc91                	j	122 <go+0xaa>
        printf("grind: create c failed\n");
     6d0:	00001517          	auipc	a0,0x1
     6d4:	e3850513          	addi	a0,a0,-456 # 1508 <malloc+0x29a>
     6d8:	00001097          	auipc	ra,0x1
     6dc:	ade080e7          	jalr	-1314(ra) # 11b6 <printf>
        exit(1);
     6e0:	4505                	li	a0,1
     ...
     6ee:	e3650513          	addi	a0,a0,-458 # 1520 <malloc+0x2b2>
     6f2:	00001097          	auipc	ra,0x1
     6f6:	ac4080e7          	jalr	-1340(ra) # 11b6 <printf>
        exit(1);
     6fa:	4505                	li	a0,1
     ...
     708:	e3450513          	addi	a0,a0,-460 # 1538 <malloc+0x2ca>
     70c:	00001097          	auipc	ra,0x1
     710:	aaa080e7          	jalr	-1366(ra) # 11b6 <printf>
        exit(1);
     714:	4505                	li	a0,1
     ...
     724:	e3050513          	addi	a0,a0,-464 # 1550 <malloc+0x2e2>
     728:	00001097          	auipc	ra,0x1
     72c:	a8e080e7          	jalr	-1394(ra) # 11b6 <printf>
        exit(1);
     730:	4505                	li	a0,1
     ...
     73e:	e3e50513          	addi	a0,a0,-450 # 1578 <malloc+0x30a>
     742:	00001097          	auipc	ra,0x1
     746:	a74080e7          	jalr	-1420(ra) # 11b6 <printf>
        exit(1);
     74a:	4505                	li	a0,1
     ...
     826:	df658593          	addi	a1,a1,-522 # 1618 <malloc+0x3aa>
     ...
     84a:	dda50513          	addi	a0,a0,-550 # 1620 <malloc+0x3b2>
     84e:	00001097          	auipc	ra,0x1
     852:	968080e7          	jalr	-1688(ra) # 11b6 <printf>
        exit(1);
     856:	4505                	li	a0,1
     ...
     864:	c4058593          	addi	a1,a1,-960 # 14a0 <malloc+0x232>
     868:	4509                	li	a0,2
     86a:	00001097          	auipc	ra,0x1
     86e:	91e080e7          	jalr	-1762(ra) # 1188 <fprintf>
        exit(1);
     872:	4505                	li	a0,1
     ...
     880:	c2458593          	addi	a1,a1,-988 # 14a0 <malloc+0x232>
     884:	4509                	li	a0,2
     886:	00001097          	auipc	ra,0x1
     88a:	902080e7          	jalr	-1790(ra) # 1188 <fprintf>
        exit(1);
     88e:	4505                	li	a0,1
     ...
     8dc:	cc858593          	addi	a1,a1,-824 # 15a0 <malloc+0x332>
     8e0:	4509                	li	a0,2
     8e2:	00001097          	auipc	ra,0x1
     8e6:	8a6080e7          	jalr	-1882(ra) # 1188 <fprintf>
          exit(1);
     8ea:	4505                	li	a0,1
     ...
     950:	b1458593          	addi	a1,a1,-1260 # 1460 <malloc+0x1f2>
     954:	4509                	li	a0,2
     956:	00001097          	auipc	ra,0x1
     95a:	832080e7          	jalr	-1998(ra) # 1188 <fprintf>
        exit(3);
     95e:	450d                	li	a0,3
     ...
     99c:	c0858593          	addi	a1,a1,-1016 # 15a0 <malloc+0x332>
     9a0:	4509                	li	a0,2
     9a2:	00000097          	auipc	ra,0x0
     9a6:	7e6080e7          	jalr	2022(ra) # 1188 <fprintf>
          exit(4);
     9aa:	4511                	li	a0,4
     ...
     9e0:	bc458593          	addi	a1,a1,-1084 # 15a0 <malloc+0x332>
     9e4:	4509                	li	a0,2
     9e6:	00000097          	auipc	ra,0x0
     9ea:	7a2080e7          	jalr	1954(ra) # 1188 <fprintf>
          exit(5);
     9ee:	4515                	li	a0,5
     ...
     a08:	bec78793          	addi	a5,a5,-1044 # 15f0 <malloc+0x382>
     a0c:	faf43423          	sd	a5,-88(s0)
     a10:	fa043823          	sd	zero,-80(s0)
        exec("/cat", args);
     a14:	fa840593          	addi	a1,s0,-88
     a18:	00001517          	auipc	a0,0x1
     a1c:	be050513          	addi	a0,a0,-1056 # 15f8 <malloc+0x38a>
     a20:	00000097          	auipc	ra,0x0
     a24:	446080e7          	jalr	1094(ra) # e66 <exec>
        fprintf(2, "grind: cat: not found\n");
     a28:	00001597          	auipc	a1,0x1
     a2c:	bd858593          	addi	a1,a1,-1064 # 1600 <malloc+0x392>
     a30:	4509                	li	a0,2
     a32:	00000097          	auipc	ra,0x0
     a36:	756080e7          	jalr	1878(ra) # 1188 <fprintf>
        exit(6);
     a3a:	4519                	li	a0,6
     ...
     a48:	a1c58593          	addi	a1,a1,-1508 # 1460 <malloc+0x1f2>
     a4c:	4509                	li	a0,2
     a4e:	00000097          	auipc	ra,0x0
     a52:	73a080e7          	jalr	1850(ra) # 1188 <fprintf>
        exit(7);
     a56:	451d                	li	a0,7
...
iter()
{
  ...
  unlink("a");
     ...
     a70:	9d450513          	addi	a0,a0,-1580 # 1440 <malloc+0x1d2>
     a74:	00000097          	auipc	ra,0x0
     a78:	40a080e7          	jalr	1034(ra) # e7e <unlink>
  unlink("b");
     a7c:	00001517          	auipc	a0,0x1
     a80:	97450513          	addi	a0,a0,-1676 # 13f0 <malloc+0x182>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     aba:	9aa50513          	addi	a0,a0,-1622 # 1460 <malloc+0x1f2>
     abe:	00000097          	auipc	ra,0x0
     ac2:	6f8080e7          	jalr	1784(ra) # 11b6 <printf>
    exit(1);
     ac6:	4505                	li	a0,1
  ...
  if(pid2 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     b02:	96250513          	addi	a0,a0,-1694 # 1460 <malloc+0x1f2>
     b06:	00000097          	auipc	ra,0x0
     b0a:	6b0080e7          	jalr	1712(ra) # 11b6 <printf>
    exit(1);
     b0e:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do
  {
    buf[i++] = digits[x % base];
     ...
     f36:	7d650513          	addi	a0,a0,2006 # 1708 <digits>
     f3a:	883a                	mv	a6,a4
...
{
     fbc:	715d                	addi	sp,sp,-80
     fbe:	e486                	sd	ra,72(sp)
     fc0:	e0a2                	sd	s0,64(sp)
     fc2:	fc26                	sd	s1,56(sp)
     fc4:	f84a                	sd	s2,48(sp)
     fc6:	f44e                	sd	s3,40(sp)
     fc8:	f052                	sd	s4,32(sp)
     fca:	ec56                	sd	s5,24(sp)
     fcc:	e85a                	sd	s6,16(sp)
     fce:	e45e                	sd	s7,8(sp)
     fd0:	e062                	sd	s8,0(sp)
     fd2:	0880                	addi	s0,sp,80
  char *s;
  int c, i, state;

  state = 0;
  for (i = 0; fmt[i]; i++)
     fd4:	0005c903          	lbu	s2,0(a1)
     fd8:	18090c63          	beqz	s2,1170 <vprintf+0x1b4>
     fdc:	8aaa                	mv	s5,a0
     fde:	8bb2                	mv	s7,a2
  ...
  state = 0;
     ...
     fea:	4b55                	li	s6,21
     fec:	a839                	j	100a <vprintf+0x4e>
        putc(fd, c);
     fee:	85ca                	mv	a1,s2
     ff0:	8556                	mv	a0,s5
     ff2:	00000097          	auipc	ra,0x0
     ff6:	efc080e7          	jalr	-260(ra) # eee <putc>
     ffa:	a019                	j	1000 <vprintf+0x44>
    else if (state == '%')
     ffc:	01498d63          	beq	s3,s4,1016 <vprintf+0x5a>
  for (i = 0; fmt[i]; i++)
    1000:	0485                	addi	s1,s1,1
    1002:	fff4c903          	lbu	s2,-1(s1)
    1006:	16090563          	beqz	s2,1170 <vprintf+0x1b4>
    if (state == 0)
    100a:	fe0999e3          	bnez	s3,ffc <vprintf+0x40>
      if (c == '%')
    100e:	ff4910e3          	bne	s2,s4,fee <vprintf+0x32>
        state = '%';
    1012:	89d2                	mv	s3,s4
    1014:	b7f5                	j	1000 <vprintf+0x44>
    {
      if (c == 'd')
    1016:	13490263          	beq	s2,s4,113a <vprintf+0x17e>
    101a:	f9d9079b          	addiw	a5,s2,-99
    101e:	0ff7f793          	zext.b	a5,a5
    1022:	12fb6563          	bltu	s6,a5,114c <vprintf+0x190>
    1026:	f9d9079b          	addiw	a5,s2,-99
    102a:	0ff7f713          	zext.b	a4,a5
    102e:	10eb6f63          	bltu	s6,a4,114c <vprintf+0x190>
    1032:	00271793          	slli	a5,a4,0x2
    1036:	00000717          	auipc	a4,0x0
    103a:	67a70713          	addi	a4,a4,1658 # 16b0 <malloc+0x442>
    ...
    1058:	ebc080e7          	jalr	-324(ra) # f10 <printint>
    105c:	8bca                	mv	s7,s2
      {
    ...
    1074:	ea0080e7          	jalr	-352(ra) # f10 <printint>
    1078:	8bca                	mv	s7,s2
      state = 0;
    107a:	4981                	li	s3,0
    107c:	b751                	j	1000 <vprintf+0x44>
    ...
    1090:	e84080e7          	jalr	-380(ra) # f10 <printint>
    1094:	8bca                	mv	s7,s2
      state = 0;
    1096:	4981                	li	s3,0
    1098:	b7a5                	j	1000 <vprintf+0x44>
        printptr(fd, va_arg(ap, uint64));
    109a:	008b8c13          	addi	s8,s7,8
    109e:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    10a2:	03000593          	li	a1,48
    10a6:	8556                	mv	a0,s5
    10a8:	00000097          	auipc	ra,0x0
    10ac:	e46080e7          	jalr	-442(ra) # eee <putc>
  putc(fd, 'x');
    10b0:	07800593          	li	a1,120
    10b4:	8556                	mv	a0,s5
    10b6:	00000097          	auipc	ra,0x0
    10ba:	e38080e7          	jalr	-456(ra) # eee <putc>
    10be:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    10c0:	00000b97          	auipc	s7,0x0
    10c4:	648b8b93          	addi	s7,s7,1608 # 1708 <digits>
    10c8:	03c9d793          	srli	a5,s3,0x3c
    10cc:	97de                	add	a5,a5,s7
    10ce:	0007c583          	lbu	a1,0(a5)
    10d2:	8556                	mv	a0,s5
    10d4:	00000097          	auipc	ra,0x0
    10d8:	e1a080e7          	jalr	-486(ra) # eee <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    10dc:	0992                	slli	s3,s3,0x4
    10de:	397d                	addiw	s2,s2,-1
    10e0:	fe0914e3          	bnez	s2,10c8 <vprintf+0x10c>
        printptr(fd, va_arg(ap, uint64));
    10e4:	8be2                	mv	s7,s8
      state = 0;
    10e6:	4981                	li	s3,0
    10e8:	bf21                	j	1000 <vprintf+0x44>
        s = va_arg(ap, char *);
    10ea:	008b8993          	addi	s3,s7,8
    10ee:	000bb903          	ld	s2,0(s7)
        if (s == 0)
    10f2:	02090163          	beqz	s2,1114 <vprintf+0x158>
        while (*s != 0)
    10f6:	00094583          	lbu	a1,0(s2)
    10fa:	c9a5                	beqz	a1,116a <vprintf+0x1ae>
          putc(fd, *s);
    10fc:	8556                	mv	a0,s5
    10fe:	00000097          	auipc	ra,0x0
    1102:	df0080e7          	jalr	-528(ra) # eee <putc>
          s++;
    1106:	0905                	addi	s2,s2,1
        while (*s != 0)
    1108:	00094583          	lbu	a1,0(s2)
    110c:	f9e5                	bnez	a1,10fc <vprintf+0x140>
        s = va_arg(ap, char *);
    110e:	8bce                	mv	s7,s3
      state = 0;
    1110:	4981                	li	s3,0
    1112:	b5fd                	j	1000 <vprintf+0x44>
          s = "(null)";
    1114:	00000917          	auipc	s2,0x0
    1118:	59490913          	addi	s2,s2,1428 # 16a8 <malloc+0x43a>
        while (*s != 0)
    111c:	02800593          	li	a1,40
    1120:	bff1                	j	10fc <vprintf+0x140>
        putc(fd, va_arg(ap, uint));
    1122:	008b8913          	addi	s2,s7,8
    1126:	000bc583          	lbu	a1,0(s7)
    112a:	8556                	mv	a0,s5
    112c:	00000097          	auipc	ra,0x0
    1130:	dc2080e7          	jalr	-574(ra) # eee <putc>
    1134:	8bca                	mv	s7,s2
      state = 0;
    1136:	4981                	li	s3,0
    1138:	b5e1                	j	1000 <vprintf+0x44>
        putc(fd, c);
    113a:	02500593          	li	a1,37
    113e:	8556                	mv	a0,s5
    1140:	00000097          	auipc	ra,0x0
    1144:	dae080e7          	jalr	-594(ra) # eee <putc>
      state = 0;
    1148:	4981                	li	s3,0
    114a:	bd5d                	j	1000 <vprintf+0x44>
        putc(fd, '%');
    114c:	02500593          	li	a1,37
    1150:	8556                	mv	a0,s5
    1152:	00000097          	auipc	ra,0x0
    1156:	d9c080e7          	jalr	-612(ra) # eee <putc>
        putc(fd, c);
    115a:	85ca                	mv	a1,s2
    115c:	8556                	mv	a0,s5
    ...
    1162:	d90080e7          	jalr	-624(ra) # eee <putc>
      state = 0;
    1166:	4981                	li	s3,0
    1168:	bd61                	j	1000 <vprintf+0x44>
        s = va_arg(ap, char *);
    116a:	8bce                	mv	s7,s3
      state = 0;
    116c:	4981                	li	s3,0
    116e:	bd49                	j	1000 <vprintf+0x44>
    }
  }
}
    ...
    1176:	7942                	ld	s2,48(sp)
    1178:	79a2                	ld	s3,40(sp)
    117a:	7a02                	ld	s4,32(sp)
    117c:	6ae2                	ld	s5,24(sp)
    117e:	6b42                	ld	s6,16(sp)
    1180:	6ba2                	ld	s7,8(sp)
    1182:	6c02                	ld	s8,0(sp)
    1184:	6161                	addi	sp,sp,80
    1186:	8082                	ret

0000000000001188 <fprintf>:
...
void fprintf(int fd, const char *fmt, ...)
{
    ...
    1190:	e010                	sd	a2,0(s0)
    1192:	e414                	sd	a3,8(s0)
    1194:	e818                	sd	a4,16(s0)
    1196:	ec1c                	sd	a5,24(s0)
    1198:	03043023          	sd	a6,32(s0)
    119c:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    11a0:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    11a4:	8622                	mv	a2,s0
    11a6:	00000097          	auipc	ra,0x0
    11aa:	e16080e7          	jalr	-490(ra) # fbc <vprintf>
}
    11ae:	60e2                	ld	ra,24(sp)
    11b0:	6442                	ld	s0,16(sp)
    11b2:	6161                	addi	sp,sp,80
    11b4:	8082                	ret

00000000000011b6 <printf>:

void printf(const char *fmt, ...)
{
    11b6:	711d                	addi	sp,sp,-96
    11b8:	ec06                	sd	ra,24(sp)
    11ba:	e822                	sd	s0,16(sp)
    11bc:	1000                	addi	s0,sp,32
    11be:	e40c                	sd	a1,8(s0)
    11c0:	e810                	sd	a2,16(s0)
    11c2:	ec14                	sd	a3,24(s0)
    11c4:	f018                	sd	a4,32(s0)
    11c6:	f41c                	sd	a5,40(s0)
    11c8:	03043823          	sd	a6,48(s0)
    11cc:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    11d0:	00840613          	addi	a2,s0,8
    11d4:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    11d8:	85aa                	mv	a1,a0
    11da:	4505                	li	a0,1
    11dc:	00000097          	auipc	ra,0x0
    11e0:	de0080e7          	jalr	-544(ra) # fbc <vprintf>
}
    11e4:	60e2                	ld	ra,24(sp)
    11e6:	6442                	ld	s0,16(sp)
    11e8:	6125                	addi	sp,sp,96
    11ea:	8082                	ret

00000000000011ec <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    ...
    11ee:	e422                	sd	s0,8(sp)
    11f0:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    11f2:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    11f6:	00001797          	auipc	a5,0x1
    11fa:	e1a7b783          	ld	a5,-486(a5) # 2010 <freep>
    11fe:	a02d                	j	1228 <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    1200:	4618                	lw	a4,8(a2)
    1202:	9f2d                	addw	a4,a4,a1
    1204:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    1208:	6398                	ld	a4,0(a5)
    120a:	6310                	ld	a2,0(a4)
    120c:	a83d                	j	124a <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    120e:	ff852703          	lw	a4,-8(a0)
    1212:	9f31                	addw	a4,a4,a2
    1214:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    1216:	ff053683          	ld	a3,-16(a0)
    121a:	a091                	j	125e <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    121c:	6398                	ld	a4,0(a5)
    121e:	00e7e463          	bltu	a5,a4,1226 <free+0x3a>
    1222:	00e6ea63          	bltu	a3,a4,1236 <free+0x4a>
{
    1226:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1228:	fed7fae3          	bgeu	a5,a3,121c <free+0x30>
    122c:	6398                	ld	a4,0(a5)
    122e:	00e6e463          	bltu	a3,a4,1236 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1232:	fee7eae3          	bltu	a5,a4,1226 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    1236:	ff852583          	lw	a1,-8(a0)
    123a:	6390                	ld	a2,0(a5)
    123c:	02059813          	slli	a6,a1,0x20
    1240:	01c85713          	srli	a4,a6,0x1c
    1244:	9736                	add	a4,a4,a3
    1246:	fae60de3          	beq	a2,a4,1200 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    124a:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    124e:	4790                	lw	a2,8(a5)
    1250:	02061593          	slli	a1,a2,0x20
    1254:	01c5d713          	srli	a4,a1,0x1c
    1258:	973e                	add	a4,a4,a5
    125a:	fae68ae3          	beq	a3,a4,120e <free+0x22>
    p->s.ptr = bp->s.ptr;
...
malloc(uint nbytes)
{
  ...
  if(p == (char*)-1)
    12c2:	5afd                	li	s5,-1
    12c4:	a895                	j	1338 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    12c6:	00001797          	auipc	a5,0x1
    12ca:	14278793          	addi	a5,a5,322 # 2408 <base>
    ...
    12dc:	b7e1                	j	12a4 <malloc+0x36>
      if(p->s.size == nunits)
    12de:	02e48c63          	beq	s1,a4,1316 <malloc+0xa8>
        p->s.size -= nunits;
    ...
    1308:	7902                	ld	s2,32(sp)
    130a:	69e2                	ld	s3,24(sp)
    130c:	6a42                	ld	s4,16(sp)
    130e:	6aa2                	ld	s5,8(sp)
    1310:	6b02                	ld	s6,0(sp)
    1312:	6121                	addi	sp,sp,64
    1314:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    1316:	6398                	ld	a4,0(a5)
    1318:	e118                	sd	a4,0(a0)
    131a:	bff1                	j	12f6 <malloc+0x88>
  hp->s.size = nu;
    131c:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    1320:	0541                	addi	a0,a0,16
    1322:	00000097          	auipc	ra,0x0
    1326:	eca080e7          	jalr	-310(ra) # 11ec <free>
  return freep;
    132a:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    132e:	d971                	beqz	a0,1302 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1330:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    1332:	4798                	lw	a4,8(a5)
    1334:	fa9775e3          	bgeu	a4,s1,12de <malloc+0x70>
    if(p == freep)
    1338:	00093703          	ld	a4,0(s2)
    133c:	853e                	mv	a0,a5
    133e:	fef719e3          	bne	a4,a5,1330 <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
    1342:	8552                	mv	a0,s4
    1344:	00000097          	auipc	ra,0x0
    1348:	b72080e7          	jalr	-1166(ra) # eb6 <sbrk>
  if(p == (char*)-1)
    134c:	fd5518e3          	bne	a0,s5,131c <malloc+0xae>
        return 0;
    1350:	4501                	li	a0,0
    1352:	bf45                	j	1302 <malloc+0x94>
