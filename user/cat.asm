...
cat(int fd)
{
  ...
  44:	89058593          	addi	a1,a1,-1904 # 8d0 <malloc+0xee>
  48:	4509                	li	a0,2
  ...
  72:	87a58593          	addi	a1,a1,-1926 # 8e8 <malloc+0x106>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 104:	80058593          	addi	a1,a1,-2048 # 900 <malloc+0x11e>
 108:	4509                	li	a0,2
 10a:	00000097          	auipc	ra,0x0
 10e:	5f2080e7          	jalr	1522(ra) # 6fc <fprintf>
      exit(1);
 112:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4aa:	4d250513          	addi	a0,a0,1234 # 978 <digits>
 4ae:	883a                	mv	a6,a4
...
void vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5ae:	37670713          	addi	a4,a4,886 # 920 <malloc+0x13e>
 ...
 638:	344b8b93          	addi	s7,s7,836 # 978 <digits>
 ...
 68c:	29090913          	addi	s2,s2,656 # 918 <malloc+0x136>
        while (*s != 0)
...
malloc(uint nbytes)
{
 ...
 83e:	9d678793          	addi	a5,a5,-1578 # 1210 <base>
 ...
 8bc:	b72080e7          	jalr	-1166(ra) # 42a <sbrk>
  if(p == (char*)-1)
